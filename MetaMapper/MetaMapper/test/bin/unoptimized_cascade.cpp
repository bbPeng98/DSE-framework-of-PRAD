...
struct conv1_shift_stencil_all_inputs_to_all_outputs_cache {
	// RAM Box: {[0, 61], [0, 61]}
	// Capacity: 3844
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  conv1_shift_stencil_all_inputs_to_all_outputs_cache() {
...
struct conv1_shift_stencil_cache {
  // Reader addrs...
    // { op_hcompute_conv2_stencil_1[root = 0, conv2_s1_y, conv2_s1_x] -> conv1_shift_stencil[1 + conv2_s1_y, 2 + conv2_s1_x] : 0 <= conv2_s1_y <= 59 and 0 <= conv2_s1_x <= 59 }
    // { op_hcompute_conv2_stencil_1[root = 0, conv2_s1_y, conv2_s1_x] -> conv1_shift_stencil[2 + conv2_s1_y, conv2_s1_x] : 0 <= conv2_s1_y <= 59 and 0 <= conv2_s1_x <= 59 }
    // { op_hcompute_conv2_stencil_1[root = 0, conv2_s1_y, conv2_s1_x] -> conv1_shift_stencil[2 + conv2_s1_y, 2 + conv2_s1_x] : 0 <= conv2_s1_y <= 59 and 0 <= conv2_s1_x <= 59 }
    // { op_hcompute_conv2_stencil_1[root = 0, conv2_s1_y, conv2_s1_x] -> conv1_shift_stencil[2 + conv2_s1_y, 1 + conv2_s1_x] : 0 <= conv2_s1_y <= 59 and 0 <= conv2_s1_x <= 59 }
    // { op_hcompute_conv2_stencil_1[root = 0, conv2_s1_y, conv2_s1_x] -> conv1_shift_stencil[conv2_s1_y, conv2_s1_x] : 0 <= conv2_s1_y <= 59 and 0 <= conv2_s1_x <= 59 }
    // { op_hcompute_conv2_stencil_1[root = 0, conv2_s1_y, conv2_s1_x] -> conv1_shift_stencil[conv2_s1_y, 1 + conv2_s1_x] : 0 <= conv2_s1_y <= 59 and 0 <= conv2_s1_x <= 59 }
    // { op_hcompute_conv2_stencil_1[root = 0, conv2_s1_y, conv2_s1_x] -> conv1_shift_stencil[conv2_s1_y, 2 + conv2_s1_x] : 0 <= conv2_s1_y <= 59 and 0 <= conv2_s1_x <= 59 }
    // { op_hcompute_conv2_stencil_1[root = 0, conv2_s1_y, conv2_s1_x] -> conv1_shift_stencil[1 + conv2_s1_y, conv2_s1_x] : 0 <= conv2_s1_y <= 59 and 0 <= conv2_s1_x <= 59 }
    // { op_hcompute_conv2_stencil_1[root = 0, conv2_s1_y, conv2_s1_x] -> conv1_shift_stencil[1 + conv2_s1_y, 1 + conv2_s1_x] : 0 <= conv2_s1_y <= 59 and 0 <= conv2_s1_x <= 59 }
  // # of banks: 1
  conv1_shift_stencil_all_inputs_to_all_outputs_cache conv1_shift_stencil_all_inputs_to_all_outputs;
};



inline void conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28_write(hw_uint<16>& conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28, conv1_shift_stencil_cache& conv1_shift_stencil, int root, int conv1_shift_s0_y, int conv1_shift_s0_x, int dynamic_address) {
  conv1_shift_stencil.conv1_shift_stencil_all_inputs_to_all_outputs.write(conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28, (((1*conv1_shift_s0_y)) - 0) * 1 + (((1*conv1_shift_s0_x)) - 0) * 62);
}

inline hw_uint<16> conv1_shift_stencil_op_hcompute_conv2_stencil_1_10_select(conv1_shift_stencil_cache& conv1_shift_stencil, int root, int conv2_s1_y, int conv2_s1_x, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // conv1_shift_stencil_op_hcompute_conv2_stencil_1_10 read pattern: { op_hcompute_conv2_stencil_1[root = 0, conv2_s1_y, conv2_s1_x] -> conv1_shift_stencil[1 + conv2_s1_y, 2 + conv2_s1_x] : 0 <= conv2_s1_y <= 59 and 0 <= conv2_s1_x <= 59 }
  auto value_conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28 = conv1_shift_stencil.conv1_shift_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (((1 + 1*conv2_s1_y)) - 0) * 1 + (((2 + 1*conv2_s1_x)) - 0) * 62);
  return value_conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28;
  return 0;
}

inline hw_uint<16> conv1_shift_stencil_op_hcompute_conv2_stencil_1_11_select(conv1_shift_stencil_cache& conv1_shift_stencil, int root, int conv2_s1_y, int conv2_s1_x, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // conv1_shift_stencil_op_hcompute_conv2_stencil_1_11 read pattern: { op_hcompute_conv2_stencil_1[root = 0, conv2_s1_y, conv2_s1_x] -> conv1_shift_stencil[2 + conv2_s1_y, conv2_s1_x] : 0 <= conv2_s1_y <= 59 and 0 <= conv2_s1_x <= 59 }
  auto value_conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28 = conv1_shift_stencil.conv1_shift_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (((2 + 1*conv2_s1_y)) - 0) * 1 + (((1*conv2_s1_x)) - 0) * 62);
  return value_conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28;
  return 0;
}

inline hw_uint<16> conv1_shift_stencil_op_hcompute_conv2_stencil_1_12_select(conv1_shift_stencil_cache& conv1_shift_stencil, int root, int conv2_s1_y, int conv2_s1_x, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // conv1_shift_stencil_op_hcompute_conv2_stencil_1_12 read pattern: { op_hcompute_conv2_stencil_1[root = 0, conv2_s1_y, conv2_s1_x] -> conv1_shift_stencil[2 + conv2_s1_y, 2 + conv2_s1_x] : 0 <= conv2_s1_y <= 59 and 0 <= conv2_s1_x <= 59 }
  auto value_conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28 = conv1_shift_stencil.conv1_shift_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (((2 + 1*conv2_s1_y)) - 0) * 1 + (((2 + 1*conv2_s1_x)) - 0) * 62);
  return value_conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28;
  return 0;
}

inline hw_uint<16> conv1_shift_stencil_op_hcompute_conv2_stencil_1_13_select(conv1_shift_stencil_cache& conv1_shift_stencil, int root, int conv2_s1_y, int conv2_s1_x, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // conv1_shift_stencil_op_hcompute_conv2_stencil_1_13 read pattern: { op_hcompute_conv2_stencil_1[root = 0, conv2_s1_y, conv2_s1_x] -> conv1_shift_stencil[2 + conv2_s1_y, 1 + conv2_s1_x] : 0 <= conv2_s1_y <= 59 and 0 <= conv2_s1_x <= 59 }
  auto value_conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28 = conv1_shift_stencil.conv1_shift_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (((2 + 1*conv2_s1_y)) - 0) * 1 + (((1 + 1*conv2_s1_x)) - 0) * 62);
  return value_conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28;
  return 0;
}

inline hw_uint<16> conv1_shift_stencil_op_hcompute_conv2_stencil_1_5_select(conv1_shift_stencil_cache& conv1_shift_stencil, int root, int conv2_s1_y, int conv2_s1_x, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // conv1_shift_stencil_op_hcompute_conv2_stencil_1_5 read pattern: { op_hcompute_conv2_stencil_1[root = 0, conv2_s1_y, conv2_s1_x] -> conv1_shift_stencil[conv2_s1_y, conv2_s1_x] : 0 <= conv2_s1_y <= 59 and 0 <= conv2_s1_x <= 59 }
  auto value_conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28 = conv1_shift_stencil.conv1_shift_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (((1*conv2_s1_y)) - 0) * 1 + (((1*conv2_s1_x)) - 0) * 62);
  return value_conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28;
  return 0;
}

inline hw_uint<16> conv1_shift_stencil_op_hcompute_conv2_stencil_1_6_select(conv1_shift_stencil_cache& conv1_shift_stencil, int root, int conv2_s1_y, int conv2_s1_x, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // conv1_shift_stencil_op_hcompute_conv2_stencil_1_6 read pattern: { op_hcompute_conv2_stencil_1[root = 0, conv2_s1_y, conv2_s1_x] -> conv1_shift_stencil[conv2_s1_y, 1 + conv2_s1_x] : 0 <= conv2_s1_y <= 59 and 0 <= conv2_s1_x <= 59 }
  auto value_conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28 = conv1_shift_stencil.conv1_shift_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (((1*conv2_s1_y)) - 0) * 1 + (((1 + 1*conv2_s1_x)) - 0) * 62);
  return value_conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28;
  return 0;
}

inline hw_uint<16> conv1_shift_stencil_op_hcompute_conv2_stencil_1_7_select(conv1_shift_stencil_cache& conv1_shift_stencil, int root, int conv2_s1_y, int conv2_s1_x, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // conv1_shift_stencil_op_hcompute_conv2_stencil_1_7 read pattern: { op_hcompute_conv2_stencil_1[root = 0, conv2_s1_y, conv2_s1_x] -> conv1_shift_stencil[conv2_s1_y, 2 + conv2_s1_x] : 0 <= conv2_s1_y <= 59 and 0 <= conv2_s1_x <= 59 }
  auto value_conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28 = conv1_shift_stencil.conv1_shift_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (((1*conv2_s1_y)) - 0) * 1 + (((2 + 1*conv2_s1_x)) - 0) * 62);
  return value_conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28;
  return 0;
}

inline hw_uint<16> conv1_shift_stencil_op_hcompute_conv2_stencil_1_8_select(conv1_shift_stencil_cache& conv1_shift_stencil, int root, int conv2_s1_y, int conv2_s1_x, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // conv1_shift_stencil_op_hcompute_conv2_stencil_1_8 read pattern: { op_hcompute_conv2_stencil_1[root = 0, conv2_s1_y, conv2_s1_x] -> conv1_shift_stencil[1 + conv2_s1_y, conv2_s1_x] : 0 <= conv2_s1_y <= 59 and 0 <= conv2_s1_x <= 59 }
  auto value_conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28 = conv1_shift_stencil.conv1_shift_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (((1 + 1*conv2_s1_y)) - 0) * 1 + (((1*conv2_s1_x)) - 0) * 62);
  return value_conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28;
  return 0;
}

inline hw_uint<16> conv1_shift_stencil_op_hcompute_conv2_stencil_1_9_select(conv1_shift_stencil_cache& conv1_shift_stencil, int root, int conv2_s1_y, int conv2_s1_x, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // conv1_shift_stencil_op_hcompute_conv2_stencil_1_9 read pattern: { op_hcompute_conv2_stencil_1[root = 0, conv2_s1_y, conv2_s1_x] -> conv1_shift_stencil[1 + conv2_s1_y, 1 + conv2_s1_x] : 0 <= conv2_s1_y <= 59 and 0 <= conv2_s1_x <= 59 }
  auto value_conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28 = conv1_shift_stencil.conv1_shift_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (((1 + 1*conv2_s1_y)) - 0) * 1 + (((1 + 1*conv2_s1_x)) - 0) * 62);
  return value_conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28;
  return 0;
}
...
inline void conv1_shift_stencil_op_hcompute_conv1_shift_stencil_write_bundle_write(hw_uint<16>& op_hcompute_conv1_shift_stencil_write, conv1_shift_stencil_cache& conv1_shift_stencil, int root, int conv1_shift_s0_y, int conv1_shift_s0_x, int dynamic_address) {
	hw_uint<16> conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28_res = op_hcompute_conv1_shift_stencil_write.extract<0, 15>();
	conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28_write(conv1_shift_stencil_op_hcompute_conv1_shift_stencil_28_res, conv1_shift_stencil, root, conv1_shift_s0_y, conv1_shift_s0_x, dynamic_address);
}
...
inline hw_uint<144> conv1_shift_stencil_op_hcompute_conv2_stencil_1_read_bundle_read(conv1_shift_stencil_cache& conv1_shift_stencil, int root, int conv2_s1_y, int conv2_s1_x, int dynamic_address) {
  // # of ports in bundle: 9
	...
	hw_uint<144> result;
	hw_uint<16> conv1_shift_stencil_op_hcompute_conv2_stencil_1_5_res = conv1_shift_stencil_op_hcompute_conv2_stencil_1_5_select(conv1_shift_stencil, root, conv2_s1_y, conv2_s1_x, dynamic_address);
	set_at<0, 144>(result, conv1_shift_stencil_op_hcompute_conv2_stencil_1_5_res);
	hw_uint<16> conv1_shift_stencil_op_hcompute_conv2_stencil_1_6_res = conv1_shift_stencil_op_hcompute_conv2_stencil_1_6_select(conv1_shift_stencil, root, conv2_s1_y, conv2_s1_x, dynamic_address);
	set_at<16, 144>(result, conv1_shift_stencil_op_hcompute_conv2_stencil_1_6_res);
	hw_uint<16> conv1_shift_stencil_op_hcompute_conv2_stencil_1_7_res = conv1_shift_stencil_op_hcompute_conv2_stencil_1_7_select(conv1_shift_stencil, root, conv2_s1_y, conv2_s1_x, dynamic_address);
	set_at<32, 144>(result, conv1_shift_stencil_op_hcompute_conv2_stencil_1_7_res);
	hw_uint<16> conv1_shift_stencil_op_hcompute_conv2_stencil_1_8_res = conv1_shift_stencil_op_hcompute_conv2_stencil_1_8_select(conv1_shift_stencil, root, conv2_s1_y, conv2_s1_x, dynamic_address);
	set_at<48, 144>(result, conv1_shift_stencil_op_hcompute_conv2_stencil_1_8_res);
	hw_uint<16> conv1_shift_stencil_op_hcompute_conv2_stencil_1_9_res = conv1_shift_stencil_op_hcompute_conv2_stencil_1_9_select(conv1_shift_stencil, root, conv2_s1_y, conv2_s1_x, dynamic_address);
	set_at<64, 144>(result, conv1_shift_stencil_op_hcompute_conv2_stencil_1_9_res);
	hw_uint<16> conv1_shift_stencil_op_hcompute_conv2_stencil_1_10_res = conv1_shift_stencil_op_hcompute_conv2_stencil_1_10_select(conv1_shift_stencil, root, conv2_s1_y, conv2_s1_x, dynamic_address);
	set_at<80, 144>(result, conv1_shift_stencil_op_hcompute_conv2_stencil_1_10_res);
	hw_uint<16> conv1_shift_stencil_op_hcompute_conv2_stencil_1_11_res = conv1_shift_stencil_op_hcompute_conv2_stencil_1_11_select(conv1_shift_stencil, root, conv2_s1_y, conv2_s1_x, dynamic_address);
	set_at<96, 144>(result, conv1_shift_stencil_op_hcompute_conv2_stencil_1_11_res);
	hw_uint<16> conv1_shift_stencil_op_hcompute_conv2_stencil_1_12_res = conv1_shift_stencil_op_hcompute_conv2_stencil_1_12_select(conv1_shift_stencil, root, conv2_s1_y, conv2_s1_x, dynamic_address);
	set_at<112, 144>(result, conv1_shift_stencil_op_hcompute_conv2_stencil_1_12_res);
	hw_uint<16> conv1_shift_stencil_op_hcompute_conv2_stencil_1_13_res = conv1_shift_stencil_op_hcompute_conv2_stencil_1_13_select(conv1_shift_stencil, root, conv2_s1_y, conv2_s1_x, dynamic_address);
	set_at<128, 144>(result, conv1_shift_stencil_op_hcompute_conv2_stencil_1_13_res);
	return result;
}
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  conv1_stencil_all_inputs_to_all_outputs_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*3844);
  }
  ~conv1_stencil_all_inputs_to_all_outputs_cache() {
    free(RAM);
...
struct conv1_stencil_cache {
  // Reader addrs...
    // { op_hcompute_conv1_shift_stencil[root = 0, conv1_shift_s0_y, conv1_shift_s0_x] -> conv1_stencil[conv1_shift_s0_y, conv1_shift_s0_x] : 0 <= conv1_shift_s0_y <= 61 and 0 <= conv1_shift_s0_x <= 61 }
  // # of banks: 1
...
inline void conv1_stencil_op_hcompute_conv1_stencil_1_16_write(hw_uint<16>& conv1_stencil_op_hcompute_conv1_stencil_1_16, conv1_stencil_cache& conv1_stencil, int root, int conv1_s1_y, int conv1_s1_x, int dynamic_address) {
  conv1_stencil.conv1_stencil_all_inputs_to_all_outputs.write(conv1_stencil_op_hcompute_conv1_stencil_1_16, (((1*conv1_s1_y)) - 0) * 1 + (((1*conv1_s1_x)) - 0) * 62);
}

inline hw_uint<16> conv1_stencil_op_hcompute_conv1_shift_stencil_29_select(conv1_stencil_cache& conv1_stencil, int root, int conv1_shift_s0_y, int conv1_shift_s0_x, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // conv1_stencil_op_hcompute_conv1_shift_stencil_29 read pattern: { op_hcompute_conv1_shift_stencil[root = 0, conv1_shift_s0_y, conv1_shift_s0_x] -> conv1_stencil[conv1_shift_s0_y, conv1_shift_s0_x] : 0 <= conv1_shift_s0_y <= 61 and 0 <= conv1_shift_s0_x <= 61 }
  auto value_conv1_stencil_op_hcompute_conv1_stencil_1_16 = conv1_stencil.conv1_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (((1*conv1_shift_s0_y)) - 0) * 1 + (((1*conv1_shift_s0_x)) - 0) * 62);
...
inline hw_uint<16> conv1_stencil_op_hcompute_conv1_shift_stencil_read_bundle_read(conv1_stencil_cache& conv1_stencil, int root, int conv1_shift_s0_y, int conv1_shift_s0_x, int dynamic_address) {
  // # of ports in bundle: 1
    // conv1_stencil_op_hcompute_conv1_shift_stencil_29

	hw_uint<16> result;
	hw_uint<16> conv1_stencil_op_hcompute_conv1_shift_stencil_29_res = conv1_stencil_op_hcompute_conv1_shift_stencil_29_select(conv1_stencil, root, conv1_shift_s0_y, conv1_shift_s0_x, dynamic_address);
	set_at<0, 16>(result, conv1_stencil_op_hcompute_conv1_shift_stencil_29_res);
	return result;
}
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  conv1_stencil_clkwrk_dsa0_all_inputs_to_all_outputs_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*3844);
  }
  ~conv1_stencil_clkwrk_dsa0_all_inputs_to_all_outputs_cache() {
    free(RAM);
...
inline void conv1_stencil_clkwrk_dsa0_op_hcompute_conv1_stencil_27_write(hw_uint<16>& conv1_stencil_clkwrk_dsa0_op_hcompute_conv1_stencil_27, conv1_stencil_clkwrk_dsa0_cache& conv1_stencil_clkwrk_dsa0, int root, int conv1_s0_y, int conv1_s0_x, int dynamic_address) {
  conv1_stencil_clkwrk_dsa0.conv1_stencil_clkwrk_dsa0_all_inputs_to_all_outputs.write(conv1_stencil_clkwrk_dsa0_op_hcompute_conv1_stencil_27, (((1*conv1_s0_y)) - 0) * 1 + (((1*conv1_s0_x)) - 0) * 62);
}
...
inline hw_uint<16> conv1_stencil_clkwrk_dsa0_op_hcompute_conv1_stencil_1_17_select(conv1_stencil_clkwrk_dsa0_cache& conv1_stencil_clkwrk_dsa0, int root, int conv1_s1_y, int conv1_s1_x, int dynamic_address) {
  ...
  auto value_conv1_stencil_clkwrk_dsa0_op_hcompute_conv1_stencil_27 = conv1_stencil_clkwrk_dsa0.conv1_stencil_clkwrk_dsa0_all_inputs_to_all_outputs.read(/*ram type address*/ (((1*conv1_s1_y)) - 0) * 1 + (((1*conv1_s1_x)) - 0) * 62);
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  conv2_stencil_all_inputs_to_all_outputs_cache() {
...
struct conv2_stencil_cache {
  // Reader addrs...
    // { op_hcompute_hw_output_stencil[root = 0, hw_output_s0_y_xo, hw_output_s0_x_xi] -> conv2_stencil[hw_output_s0_y_xo, hw_output_s0_x_xi] : 0 <= hw_output_s0_y_xo <= 59 and 0 <= hw_output_s0_x_xi <= 59 }
  // # of banks: 1
...
inline void conv2_stencil_op_hcompute_conv2_stencil_1_4_write(hw_uint<16>& conv2_stencil_op_hcompute_conv2_stencil_1_4, conv2_stencil_cache& conv2_stencil, int root, int conv2_s1_y, int conv2_s1_x, int dynamic_address) {
  conv2_stencil.conv2_stencil_all_inputs_to_all_outputs.write(conv2_stencil_op_hcompute_conv2_stencil_1_4, (((1*conv2_s1_y)) - 0) * 1 + (((1*conv2_s1_x)) - 0) * 60);
}

inline hw_uint<16> conv2_stencil_op_hcompute_hw_output_stencil_1_select(conv2_stencil_cache& conv2_stencil, int root, int hw_output_s0_y_xo, int hw_output_s0_x_xi, int dynamic_address) {
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // conv2_stencil_op_hcompute_hw_output_stencil_1 read pattern: { op_hcompute_hw_output_stencil[root = 0, hw_output_s0_y_xo, hw_output_s0_x_xi] -> conv2_stencil[hw_output_s0_y_xo, hw_output_s0_x_xi] : 0 <= hw_output_s0_y_xo <= 59 and 0 <= hw_output_s0_x_xi <= 59 }
  auto value_conv2_stencil_op_hcompute_conv2_stencil_1_4 = conv2_stencil.conv2_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (((1*hw_output_s0_y_xo)) - 0) * 1 + (((1*hw_output_s0_x_xi)) - 0) * 60);
...
inline hw_uint<16> conv2_stencil_op_hcompute_hw_output_stencil_read_bundle_read(conv2_stencil_cache& conv2_stencil, int root, int hw_output_s0_y_xo, int hw_output_s0_x_xi, int dynamic_address) {
  // # of ports in bundle: 1
    // conv2_stencil_op_hcompute_hw_output_stencil_1

	hw_uint<16> result;
	hw_uint<16> conv2_stencil_op_hcompute_hw_output_stencil_1_res = conv2_stencil_op_hcompute_hw_output_stencil_1_select(conv2_stencil, root, hw_output_s0_y_xo, hw_output_s0_x_xi, dynamic_address);
...
#ifndef __VIVADO_SYNTH__
  hw_uint<16>* RAM;
  conv2_stencil_clkwrk_dsa1_all_inputs_to_all_outputs_cache() {
    RAM = (hw_uint<16>*) malloc(sizeof(hw_uint<16>)*3600);
  }
  ~conv2_stencil_clkwrk_dsa1_all_inputs_to_all_outputs_cache() {
    free(RAM);
...
inline void conv2_stencil_clkwrk_dsa1_op_hcompute_conv2_stencil_15_write(hw_uint<16>& conv2_stencil_clkwrk_dsa1_op_hcompute_conv2_stencil_15, conv2_stencil_clkwrk_dsa1_cache& conv2_stencil_clkwrk_dsa1, int root, int conv2_s0_y, int conv2_s0_x, int dynamic_address) {
  conv2_stencil_clkwrk_dsa1.conv2_stencil_clkwrk_dsa1_all_inputs_to_all_outputs.write(conv2_stencil_clkwrk_dsa1_op_hcompute_conv2_stencil_15, (((1*conv2_s0_y)) - 0) * 1 + (((1*conv2_s0_x)) - 0) * 60);
}
...
inline hw_uint<16> conv2_stencil_clkwrk_dsa1_op_hcompute_conv2_stencil_1_14_select(conv2_stencil_clkwrk_dsa1_cache& conv2_stencil_clkwrk_dsa1, int root, int conv2_s1_y, int conv2_s1_x, int dynamic_address) {
  ...
  auto value_conv2_stencil_clkwrk_dsa1_op_hcompute_conv2_stencil_15 = conv2_stencil_clkwrk_dsa1.conv2_stencil_clkwrk_dsa1_all_inputs_to_all_outputs.read(/*ram type address*/ (((1*conv2_s1_y)) - 0) * 1 + (((1*conv2_s1_x)) - 0) * 60);
...
inline hw_uint<16> hw_input_global_wrapper_stencil_op_hcompute_conv1_stencil_1_18_select(hw_input_global_wrapper_stencil_cache& hw_input_global_wrapper_stencil, int root, int conv1_s1_y, int conv1_s1_x, int dynamic_address) {
  ...
  auto value_hw_input_global_wrapper_stencil_op_hcompute_hw_input_global_wrapper_stencil_2 = hw_input_global_wrapper_stencil.hw_input_global_wrapper_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (((1*conv1_s1_y)) - 0) * 1 + (((1*conv1_s1_x)) - 0) * 64);
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // hw_input_global_wrapper_stencil_op_hcompute_conv1_stencil_1_19 read pattern: { op_hcompute_conv1_stencil_1[root = 0, conv1_s1_y, conv1_s1_x] -> hw_input_global_wrapper_stencil[conv1_s1_y, 1 + conv1_s1_x] : 0 <= conv1_s1_y <= 61 and 0 <= conv1_s1_x <= 61 }
  auto value_hw_input_global_wrapper_stencil_op_hcompute_hw_input_global_wrapper_stencil_2 = hw_input_global_wrapper_stencil.hw_input_global_wrapper_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (((1*conv1_s1_y)) - 0) * 1 + (((1 + 1*conv1_s1_x)) - 0) * 64);
  return value_hw_input_global_wrapper_stencil_op_hcompute_hw_input_global_wrapper_stencil_2;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // hw_input_global_wrapper_stencil_op_hcompute_conv1_stencil_1_20 read pattern: { op_hcompute_conv1_stencil_1[root = 0, conv1_s1_y, conv1_s1_x] -> hw_input_global_wrapper_stencil[conv1_s1_y, 2 + conv1_s1_x] : 0 <= conv1_s1_y <= 61 and 0 <= conv1_s1_x <= 61 }
  auto value_hw_input_global_wrapper_stencil_op_hcompute_hw_input_global_wrapper_stencil_2 = hw_input_global_wrapper_stencil.hw_input_global_wrapper_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (((1*conv1_s1_y)) - 0) * 1 + (((2 + 1*conv1_s1_x)) - 0) * 64);
  return value_hw_input_global_wrapper_stencil_op_hcompute_hw_input_global_wrapper_stencil_2;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // hw_input_global_wrapper_stencil_op_hcompute_conv1_stencil_1_21 read pattern: { op_hcompute_conv1_stencil_1[root = 0, conv1_s1_y, conv1_s1_x] -> hw_input_global_wrapper_stencil[1 + conv1_s1_y, conv1_s1_x] : 0 <= conv1_s1_y <= 61 and 0 <= conv1_s1_x <= 61 }
  auto value_hw_input_global_wrapper_stencil_op_hcompute_hw_input_global_wrapper_stencil_2 = hw_input_global_wrapper_stencil.hw_input_global_wrapper_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (((1 + 1*conv1_s1_y)) - 0) * 1 + (((1*conv1_s1_x)) - 0) * 64);
  return value_hw_input_global_wrapper_stencil_op_hcompute_hw_input_global_wrapper_stencil_2;
  return 0;
}
...
inline hw_uint<16> hw_input_global_wrapper_stencil_op_hcompute_conv1_stencil_1_22_select(hw_input_global_wrapper_stencil_cache& hw_input_global_wrapper_stencil, int root, int conv1_s1_y, int conv1_s1_x, int dynamic_address) {
  ...
  auto value_hw_input_global_wrapper_stencil_op_hcompute_hw_input_global_wrapper_stencil_2 = hw_input_global_wrapper_stencil.hw_input_global_wrapper_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (((1 + 1*conv1_s1_y)) - 0) * 1 + (((1 + 1*conv1_s1_x)) - 0) * 64);
  return value_hw_input_global_wrapper_stencil_op_hcompute_hw_input_global_wrapper_stencil_2;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // hw_input_global_wrapper_stencil_op_hcompute_conv1_stencil_1_23 read pattern: { op_hcompute_conv1_stencil_1[root = 0, conv1_s1_y, conv1_s1_x] -> hw_input_global_wrapper_stencil[1 + conv1_s1_y, 2 + conv1_s1_x] : 0 <= conv1_s1_y <= 61 and 0 <= conv1_s1_x <= 61 }
  auto value_hw_input_global_wrapper_stencil_op_hcompute_hw_input_global_wrapper_stencil_2 = hw_input_global_wrapper_stencil.hw_input_global_wrapper_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (((1 + 1*conv1_s1_y)) - 0) * 1 + (((2 + 1*conv1_s1_x)) - 0) * 64);
  return value_hw_input_global_wrapper_stencil_op_hcompute_hw_input_global_wrapper_stencil_2;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // hw_input_global_wrapper_stencil_op_hcompute_conv1_stencil_1_24 read pattern: { op_hcompute_conv1_stencil_1[root = 0, conv1_s1_y, conv1_s1_x] -> hw_input_global_wrapper_stencil[2 + conv1_s1_y, conv1_s1_x] : 0 <= conv1_s1_y <= 61 and 0 <= conv1_s1_x <= 61 }
  auto value_hw_input_global_wrapper_stencil_op_hcompute_hw_input_global_wrapper_stencil_2 = hw_input_global_wrapper_stencil.hw_input_global_wrapper_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (((2 + 1*conv1_s1_y)) - 0) * 1 + (((1*conv1_s1_x)) - 0) * 64);
  return value_hw_input_global_wrapper_stencil_op_hcompute_hw_input_global_wrapper_stencil_2;
  return 0;
}
...
inline hw_uint<16> hw_input_global_wrapper_stencil_op_hcompute_conv1_stencil_1_25_select(hw_input_global_wrapper_stencil_cache& hw_input_global_wrapper_stencil, int root, int conv1_s1_y, int conv1_s1_x, int dynamic_address) {
  ...
  auto value_hw_input_global_wrapper_stencil_op_hcompute_hw_input_global_wrapper_stencil_2 = hw_input_global_wrapper_stencil.hw_input_global_wrapper_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (((2 + 1*conv1_s1_y)) - 0) * 1 + (((2 + 1*conv1_s1_x)) - 0) * 64);
  return value_hw_input_global_wrapper_stencil_op_hcompute_hw_input_global_wrapper_stencil_2;
  return 0;
}
...
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
  // hw_input_global_wrapper_stencil_op_hcompute_conv1_stencil_1_26 read pattern: { op_hcompute_conv1_stencil_1[root = 0, conv1_s1_y, conv1_s1_x] -> hw_input_global_wrapper_stencil[2 + conv1_s1_y, 1 + conv1_s1_x] : 0 <= conv1_s1_y <= 61 and 0 <= conv1_s1_x <= 61 }
  auto value_hw_input_global_wrapper_stencil_op_hcompute_hw_input_global_wrapper_stencil_2 = hw_input_global_wrapper_stencil.hw_input_global_wrapper_stencil_all_inputs_to_all_outputs.read(/*ram type address*/ (((2 + 1*conv1_s1_y)) - 0) * 1 + (((1 + 1*conv1_s1_x)) - 0) * 64);
  return value_hw_input_global_wrapper_stencil_op_hcompute_hw_input_global_wrapper_stencil_2;
  return 0;
}
...
// Total re-use buffer capacity: 365248 bits
...
inline void op_hcompute_conv1_shift_stencil(conv1_stencil_cache& conv1_stencil, conv1_shift_stencil_cache& conv1_shift_stencil, int root, int conv1_shift_s0_y, int conv1_shift_s0_x) {
  // Dynamic address computation

	// Consume: conv1_stencil
	auto conv1_stencil_conv1_shift_s0_y_c__conv1_shift_s0_x_value = conv1_stencil_op_hcompute_conv1_shift_stencil_read_bundle_read(conv1_stencil/* source_delay */, root, conv1_shift_s0_y, conv1_shift_s0_x, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = hcompute_conv1_shift_stencil(conv1_stencil_conv1_shift_s0_y_c__conv1_shift_s0_x_value);
	// Produce: conv1_shift_stencil
	conv1_shift_stencil_op_hcompute_conv1_shift_stencil_write_bundle_write(/* arg names */compute_result, conv1_shift_stencil, root, conv1_shift_s0_y, conv1_shift_s0_x, 0);
...
inline void op_hcompute_conv2_stencil_1(conv1_shift_stencil_cache& conv1_shift_stencil, conv2_stencil_clkwrk_dsa1_cache& conv2_stencil_clkwrk_dsa1, conv2_stencil_cache& conv2_stencil, int root, int conv2_s1_y, int conv2_s1_x) {
  // Dynamic address computation

	// Consume: conv1_shift_stencil
	auto conv1_shift_stencil_conv2_s1_y_c__conv2_s1_x_value = conv1_shift_stencil_op_hcompute_conv2_stencil_1_read_bundle_read(conv1_shift_stencil/* source_delay */, root, conv2_s1_y, conv2_s1_x, 0);
	...
	auto compute_result = hcompute_conv2_stencil_1(conv1_shift_stencil_conv2_s1_y_c__conv2_s1_x_value, conv2_stencil_clkwrk_dsa1_conv2_s1_y_c__conv2_s1_x_value);
...
inline void op_hcompute_hw_output_stencil(conv2_stencil_cache& conv2_stencil, HWStream<hw_uint<16> >& /* buffer_args num ports = 1 */hw_output_stencil, int root, int hw_output_s0_y_xo, int hw_output_s0_x_xi) {
  // Dynamic address computation

	// Consume: conv2_stencil
	auto conv2_stencil_hw_output_s0_y_xo_c__hw_output_s0_x_xi_value = conv2_stencil_op_hcompute_hw_output_stencil_read_bundle_read(conv2_stencil/* source_delay */, root, hw_output_s0_y_xo, hw_output_s0_x_xi, 0);

#ifndef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__

	auto compute_result = hcompute_hw_output_stencil(conv2_stencil_hw_output_s0_y_xo_c__hw_output_s0_x_xi_value);
...
#endif //__VIVADO_SYNTH__
  conv1_shift_stencil_cache conv1_shift_stencil;
#ifdef __VIVADO_SYNTH__
#endif //__VIVADO_SYNTH__
...
//   { op_hcompute_conv2_stencil_1[root = 0, conv2_s1_y, conv2_s1_x] -> [0, 0, 5, conv2_s1_y, 0, conv2_s1_x, 0] : 0 <= conv2_s1_y <= 59 and 0 <= conv2_s1_x <= 59 }
// Condition for op_hcompute_conv2_stencil_1(((((1*i6)) == 0) && (((1*i4)) == 0) && (((-5 + 1*i2)) == 0) && (((1*i1)) == 0) && (((1*i0)) == 0) && (((1*i3)) >= 0) && (((59 + -1*i3)) >= 0) && (((1*i5)) >= 0) && (((59 + -1*i5)) >= 0)))
...
//   { op_hcompute_conv1_shift_stencil[root = 0, conv1_shift_s0_y, conv1_shift_s0_x] -> [0, 0, 3, conv1_shift_s0_y, 0, conv1_shift_s0_x, 0] : 0 <= conv1_shift_s0_y <= 61 and 0 <= conv1_shift_s0_x <= 61 }
// Condition for op_hcompute_conv1_shift_stencil(((((1*i6)) == 0) && (((1*i4)) == 0) && (((-3 + 1*i2)) == 0) && (((1*i1)) == 0) && (((1*i0)) == 0) && (((1*i3)) >= 0) && (((61 + -1*i3)) >= 0) && (((1*i5)) >= 0) && (((61 + -1*i5)) >= 0)))
//   { op_hcompute_conv2_stencil[root = 0, conv2_s0_y, conv2_s0_x] -> [0, 0, 4, conv2_s0_y, 0, conv2_s0_x, 0] : 0 <= conv2_s0_y <= 59 and 0 <= conv2_s0_x <= 59 }
// Condition for op_hcompute_conv2_stencil(((((1*i6)) == 0) && (((1*i4)) == 0) && (((-4 + 1*i2)) == 0) && (((1*i1)) == 0) && (((1*i0)) == 0) && (((1*i3)) >= 0) && (((59 + -1*i3)) >= 0) && (((1*i5)) >= 0) && (((59 + -1*i5)) >= 0)))
//   { op_hcompute_hw_output_stencil[root = 0, hw_output_s0_y_xo, hw_output_s0_x_xi] -> [0, 0, 6, hw_output_s0_y_xo, 0, hw_output_s0_x_xi, 0] : 0 <= hw_output_s0_y_xo <= 59 and 0 <= hw_output_s0_x_xi <= 59 }
// Condition for op_hcompute_hw_output_stencil(((((1*i6)) == 0) && (((1*i4)) == 0) && (((-6 + 1*i2)) == 0) && (((1*i1)) == 0) && (((1*i0)) == 0) && (((1*i3)) >= 0) && (((59 + -1*i3)) >= 0) && (((1*i5)) >= 0) && (((59 + -1*i5)) >= 0)))

	{
	  ...
	  for (int c3 = 0; c3 <= 61; c3 += 1)
	    for (int c5 = 0; c5 <= 61; c5 += 1)
	      op_hcompute_conv1_shift_stencil(conv1_stencil /* buf name */, conv1_shift_stencil, 0, c3, c5);
	  for (int c3 = 0; c3 <= 59; c3 += 1)
	    for (int c5 = 0; c5 <= 59; c5 += 1)
	      op_hcompute_conv2_stencil(conv2_stencil_clkwrk_dsa1, 0, c3, c5);
	  for (int c3 = 0; c3 <= 59; c3 += 1)
	    for (int c5 = 0; c5 <= 59; c5 += 1)
	      op_hcompute_conv2_stencil_1(conv1_shift_stencil /* buf name */, conv2_stencil_clkwrk_dsa1 /* buf name */, conv2_stencil, 0, c3, c5);
	  for (int c3 = 0; c3 <= 59; c3 += 1)
	    for (int c5 = 0; c5 <= 59; c5 += 1)
...
const int op_hcompute_hw_input_global_wrapper_stencil_read_pipe0_num_transfers = 4096;
  // { op_hcompute_hw_output_stencil[root = 0, hw_output_s0_y_xo, hw_output_s0_x_xi] -> hw_output_stencil[hw_output_s0_y_xo, hw_output_s0_x_xi] : 0 <= hw_output_s0_y_xo <= 59 and 0 <= hw_output_s0_x_xi <= 59 }
