#ifndef HALIDE_____bin___cascade_h
#define HALIDE_____bin___cascade_h
#include <stdint.h>
...
int cascade(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int cascade_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *cascade_metadata() HALIDE_FUNCTION_ATTRS;
