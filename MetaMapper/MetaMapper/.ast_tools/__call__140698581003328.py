...
def __call__(self, alu: Const(my_ALU_t), signed_: Const(Signed_t), a: DataPy, b: DataPy, c: DataPy, d: BitPy) -> (DataPy, BitPy, BitPy, BitPy, BitPy, BitPy):
    ...
    adder2_in1_3 = ~c
    Cin2_3 = Bit(1)
    Cin2_4 = __phi(_cond_7, Cin2_3, Cin2_2)
    adder2_in1_4 = __phi(_cond_7, adder2_in1_3, adder2_in1_2)
    adder2_res_0, adder2_C_0 = UData(adder2_in0_4).adc(adder2_in1_4, Cin2_4)
