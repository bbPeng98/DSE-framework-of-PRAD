...
def __call__(
    ...
    rg_0, rg_rdata_0 = self.regg(inst.regg, inst.bit3, bit3, clk_en)
    rh_0, rh_rdata_0 = self.regf(inst.regh, inst.bit4, bit4, clk_en)
    ri_0, ri_rdata_0 = self.regf(inst.regi, inst.bit5, bit5, clk_en)
    alu_res_0, alu_res_p_0, Z_0, N_0, C_0, V_0 = self.alu(inst.alu, inst.signed, ra_0, rb_0, rc_0, rd_0)
    lut_res_0 = self.lut(inst.lut, rd_0, re_0, rf_0, rg_0, rh_0 ,ri_0)
