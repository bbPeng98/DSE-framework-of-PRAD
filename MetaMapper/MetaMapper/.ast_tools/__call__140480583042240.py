...
def __call__(self, alu: Const(my_ALU_t), signed_: Const(Signed_t), a: DataPy, b: DataPy, c: DataPy, d: BitPy) -> (DataPy, BitPy, BitPy, BitPy, BitPy, BitPy):
    ...
    _cond_6 = (alu == my_ALU_t.TSS)
    adder2_in0_5 = adder_res_0
    adder2_in0_6 = __phi(_cond_6, adder2_in0_5, adder2_in0_4)
    adder2_in1_0 = c
    Cin2_0 = Bit(0)
    _cond_7 = (alu == my_ALU_t.TAS)
    adder2_in1_1 = ~c
    Cin2_1 = Bit(1)
    Cin2_2 = __phi(_cond_7, Cin2_1, Cin2_0)
    adder2_in1_2 = __phi(_cond_7, adder2_in1_1, adder2_in1_0)
    _cond_8 = (alu == my_ALU_t.TSS)
    adder2_in1_3 = ~c
    Cin2_3 = Bit(1)
    Cin2_4 = __phi(_cond_8, Cin2_3, Cin2_2)
    adder2_in1_4 = __phi(_cond_8, adder2_in1_3, adder2_in1_2)
    adder2_res_0, adder2_C_0 = UData(adder2_in0_6).adc(adder2_in1_4, Cin2_4)
    _cond_9 = (alu == my_ALU_t.Mult0)
    res_1, C_1, V_1 = mul_0[:16], Bit(0), Bit(0)  # wrong C, V
    res_p_1 = C_1
    C_2 = __phi(_cond_9, C_1, C_0)
    V_2 = __phi(_cond_9, V_1, V_0)
    res_2 = __phi(_cond_9, res_1, res_0)
    res_p_2 = __phi(_cond_9, res_p_1, res_p_0)
    _cond_10 = (alu == my_ALU_t.MULADD)
    res_3, res_p_3 = adder2_res_0, Bit(0)
    res_4 = __phi(_cond_10, res_3, res_2)
    res_p_4 = __phi(_cond_10, res_p_3, res_p_2)
    _cond_11 = (alu == my_ALU_t.TAA)
    res_5, res_p_5 = adder2_res_0, Bit(0)
    res_6 = __phi(_cond_11, res_5, res_4)
    res_p_6 = __phi(_cond_11, res_p_5, res_p_4)
    _cond_12 = (alu == my_ALU_t.TAS)
    res_7, res_p_7 = adder2_res_0, Bit(0)
    res_8 = __phi(_cond_12, res_7, res_6)
    res_p_8 = __phi(_cond_12, res_p_7, res_p_6)
    _cond_13 = (alu == my_ALU_t.TSS)
    res_9, res_p_9 = adder2_res_0, Bit(0)
    res_10 = __phi(_cond_13, res_9, res_8)
    res_p_10 = __phi(_cond_13, res_p_9, res_p_8)
    N_0 = Bit(res_10[-1])
    Z_0 = (res_10 == SData(0))
    __0_return_0 = res_10, res_p_10, Z_0, N_0, C_2, V_2
    return __0_return_0
