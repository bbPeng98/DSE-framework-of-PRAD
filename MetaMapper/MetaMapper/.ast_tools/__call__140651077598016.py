...
def __call__(self, alu: Const(my_ALU_t), signed_: Const(Signed_t), a: DataPy, b: DataPy, c: DataPy, d: BitPy) -> (DataPy, BitPy, BitPy, BitPy, BitPy, BitPy):
    ...
    adder2_res_0, adder2_C_0 = UData(adder2_in0_6).adc(adder2_in1_2, Cin2_2)
    _cond_8 = (alu == my_ALU_t.Add)
    res_1, C_1 = adder_res_0, adder_C_0
    V_1 = overflow(a, b_1, res_1)
    res_p_1 = C_1
    C_2 = __phi(_cond_8, C_1, C_0)
    V_2 = __phi(_cond_8, V_1, V_0)
    res_2 = __phi(_cond_8, res_1, res_0)
    res_p_2 = __phi(_cond_8, res_p_1, res_p_0)
    _cond_9 = (alu == my_ALU_t.Mult0)
    res_3, C_3, V_3 = mul_0[:16], Bit(0), Bit(0)  # wrong C, V
    res_p_3 = C_3
    C_4 = __phi(_cond_9, C_3, C_2)
    V_4 = __phi(_cond_9, V_3, V_2)
    res_4 = __phi(_cond_9, res_3, res_2)
    res_p_4 = __phi(_cond_9, res_p_3, res_p_2)
    _cond_10 = (alu == my_ALU_t.MULADD)
    res_5, res_p_5 = adder2_res_0, Bit(0)
    res_6 = __phi(_cond_10, res_5, res_4)
    res_p_6 = __phi(_cond_10, res_p_5, res_p_4)
    _cond_11 = (alu == my_ALU_t.TAA)
    res_7, res_p_7 = adder2_res_0, Bit(0)
    res_8 = __phi(_cond_11, res_7, res_6)
    res_p_8 = __phi(_cond_11, res_p_7, res_p_6)
    _cond_12 = (alu == my_ALU_t.TSA)
    res_9, res_p_9 = adder2_res_0, Bit(0)
    res_10 = __phi(_cond_12, res_9, res_8)
    res_p_10 = __phi(_cond_12, res_p_9, res_p_8)
    _cond_13 = (alu == my_ALU_t.TAS)
    res_11, res_p_11 = adder2_res_0, Bit(0)
    res_12 = __phi(_cond_13, res_11, res_10)
    res_p_12 = __phi(_cond_13, res_p_11, res_p_10)
    N_0 = Bit(res_12[-1])
    Z_0 = (res_12 == SData(0))
