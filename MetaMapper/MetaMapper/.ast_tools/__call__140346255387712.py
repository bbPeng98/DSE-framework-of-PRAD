...
def __call__(self, alu: Const(my_ALU_t), signed_: Const(Signed_t), a: DataPy, b: DataPy, d: BitPy) -> (DataPy, BitPy, BitPy, BitPy, BitPy, BitPy):
    ...
    _cond_2 = (alu == my_ALU_t.Add)
    res_1, C_1 = adder_res_0, adder_C_0
    V_1 = overflow(a, b_1, res_1)
    res_p_1 = C_1
    C_2 = __phi(_cond_2, C_1, C_0)
    V_2 = __phi(_cond_2, V_1, V_0)
    res_2 = __phi(_cond_2, res_1, res_0)
    res_p_2 = __phi(_cond_2, res_p_1, res_p_0)
    _cond_3 = (alu == my_ALU_t.Sub)
    res_3, C_3 = adder_res_0, adder_C_0
    V_3 = overflow(a, b_1, res_3)
    res_p_3 = C_3
    C_4 = __phi(_cond_3, C_3, C_2)
    V_4 = __phi(_cond_3, V_3, V_2)
    res_4 = __phi(_cond_3, res_3, res_2)
    res_p_4 = __phi(_cond_3, res_p_3, res_p_2)
    _cond_4 = (alu == my_ALU_t.Mult0)
    res_5, C_5, V_5 = mul_0[:16], Bit(0), Bit(0)  # wrong C, V
    res_p_5 = C_5
    C_6 = __phi(_cond_4, C_5, C_4)
    V_6 = __phi(_cond_4, V_5, V_4)
    res_6 = __phi(_cond_4, res_5, res_4)
    res_p_6 = __phi(_cond_4, res_p_5, res_p_4)
    _cond_5 = (alu == my_ALU_t.And)
    res_7, res_p_7 = a & b_1, Bit(0)
    res_8 = __phi(_cond_5, res_7, res_6)
    res_p_8 = __phi(_cond_5, res_p_7, res_p_6)
    _cond_6 = (alu == my_ALU_t.SHR)
    res_9, res_p_9 = shr_2, Bit(0)
    res_10 = __phi(_cond_6, res_9, res_8)
    res_p_10 = __phi(_cond_6, res_p_9, res_p_8)
    N_0 = Bit(res_10[-1])
    Z_0 = (res_10 == SData(0))
    __0_return_0 = res_10, res_p_10, Z_0, N_0, C_6, V_6
    return __0_return_0
