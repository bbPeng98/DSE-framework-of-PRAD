...
def __call__(self, alu: Const(my_ALU_t), signed_: Const(Signed_t), a: DataPy, b: DataPy, c: DataPy, d: BitPy) -> (DataPy, BitPy, BitPy, BitPy, BitPy, BitPy):
    ...
    adder2_in0_4 = __phi(_cond_4, adder2_in0_3, adder2_in0_2)
    adder2_in1_0 = c
    Cin2_0 = Bit(0)
    _cond_5 = (alu == my_ALU_t.TAS)
    adder2_in1_1 = ~c
    Cin2_1 = Bit(1)
    Cin2_2 = __phi(_cond_5, Cin2_1, Cin2_0)
    adder2_in1_2 = __phi(_cond_5, adder2_in1_1, adder2_in1_0)
