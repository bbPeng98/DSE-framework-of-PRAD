...
int absolute_clockwork(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
...
_255;
  ...
  RDAI_VLNV device_vlnv = {{"aha"}, {"halide_hardware"}, {"absolute"}, 1};
  ...
  int32_t _296 = _halide_buffer_get_min(_output_buffer, 1);
  bool _297 = 0 <= _296;
  int32_t _298 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _299 = _298 + _296;
  bool _300 = _299 <= 64;
  bool _301 = _297 && _300;
  if (!_301)   {
   int32_t _302 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _303 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _304 = _303 + _302;
   int32_t _305 = _304 + -1;
   int32_t _306 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 63, _302, _305);
   return _306;
  }
  int32_t _307 = _halide_buffer_get_min(_output_buffer, 0);
  bool _308 = 0 <= _307;
  int32_t _309 = _halide_buffer_get_extent(_output_buffer, 0);
  int32_t _310 = _309 + _307;
  bool _311 = _310 <= 64;
  bool _312 = _308 && _311;
  if (!_312)   {
   int32_t _313 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _314 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _315 = _314 + _313;
   int32_t _316 = _315 + -1;
   int32_t _317 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 63, _313, _316);
   return _317;
  }
  // produce output
  for (int _output_s0_y = 0; _output_s0_y < 0 + 64; _output_s0_y++)
  {
   ...
   {
    int32_t _318 = _output_s0_y * 64;
    int32_t _319 = _318 + _output_s0_x;
_319;
    uint16_t *_hw_output_stencil_host = (uint16_t *) _hw_output_stencil->host_ptr;
    uint16_t _320 = _hw_output_stencil_host[_319];
    uint8_t _321 = (uint8_t)(_320);
    int32_t _322 = _halide_buffer_get_stride(_output_buffer, 1);
    int32_t _323 = _322 * _output_s0_y;
    int32_t _324 = _323 + _output_s0_x;
    ((uint8_t *)_output)[_324] = _321;
   } // for _output_s0_x
  } // for _output_s0_y
