#ifndef HALIDE_____bin___absolute_h
#define HALIDE_____bin___absolute_h
#include <stdint.h>
...
int absolute(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int absolute_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *absolute_metadata() HALIDE_FUNCTION_ATTRS;
