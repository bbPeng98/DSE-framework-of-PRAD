...
int cascade_clockwork(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
...
_255;
  ...
  RDAI_VLNV device_vlnv = {{"aha"}, {"halide_hardware"}, {"cascade"}, 1};
  ...
  int32_t _401 = _halide_buffer_get_min(_output_buffer, 1);
  bool _402 = 0 <= _401;
  int32_t _403 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _404 = _403 + _401;
  bool _405 = _404 <= 60;
  bool _406 = _402 && _405;
  if (!_406)   {
   int32_t _407 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _408 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _409 = _408 + _407;
   int32_t _410 = _409 + -1;
   int32_t _411 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 59, _407, _410);
   return _411;
  }
  int32_t _412 = _halide_buffer_get_min(_output_buffer, 0);
  bool _413 = 0 <= _412;
  int32_t _414 = _halide_buffer_get_extent(_output_buffer, 0);
  int32_t _415 = _414 + _412;
  bool _416 = _415 <= 60;
  bool _417 = _413 && _416;
  if (!_417)   {
   int32_t _418 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _419 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _420 = _419 + _418;
   int32_t _421 = _420 + -1;
   int32_t _422 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 59, _418, _421);
   return _422;
  }
  // produce output
  for (int _output_s0_y = 0; _output_s0_y < 0 + 60; _output_s0_y++)
  {
   ...
   {
    int32_t _423 = _output_s0_y * 60;
    int32_t _424 = _423 + _output_s0_x;
_424;
    uint16_t *_hw_output_stencil_host = (uint16_t *) _hw_output_stencil->host_ptr;
    uint16_t _425 = _hw_output_stencil_host[_424];
    uint8_t _426 = (uint8_t)(_425);
    int32_t _427 = _halide_buffer_get_stride(_output_buffer, 1);
    int32_t _428 = _427 * _output_s0_y;
    int32_t _429 = _428 + _output_s0_x;
    ((uint8_t *)_output)[_429] = _426;
   } // for _output_s0_x
  } // for _output_s0_y
