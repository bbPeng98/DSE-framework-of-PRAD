...
int camera_pipeline_shared_clockwork(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
 ...
 if (_25)
 {
  ...
  if (!_51)   {
   ...
   int32_t _54 = _53 + _52;
   int32_t _55 = _54 + -1;
   int32_t _56 = halide_error_access_out_of_bounds(_ucon, "Input buffer input", 0, 0, 2487, _52, _55);
   return _56;
  }
  ...
  if (!_66)   {
   ...
   int32_t _69 = _68 + _67;
   int32_t _70 = _69 + -1;
   int32_t _71 = halide_error_access_out_of_bounds(_ucon, "Input buffer input", 1, 0, 1847, _67, _70);
   return _71;
  }
  ...
  if (!_81)   {
   ...
   int32_t _84 = _83 + _82;
   int32_t _85 = _84 + -1;
   int32_t _86 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 0, 0, 2479, _82, _85);
   return _86;
  }
  ...
  if (!_96)   {
   ...
   int32_t _99 = _98 + _97;
   int32_t _100 = _99 + -1;
   int32_t _101 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 1, 0, 1839, _97, _100);
   return _101;
  }
  ...
  RDAI_MemObject *_hw_input_stencil = RDAI_mem_shared_allocate(17445120);
  // produce hw_input.stencil
  for (int _hw_input_s0_y = -4; _hw_input_s0_y < -4 + 1848; _hw_input_s0_y++)
  {
   for (int _hw_input_s0_x = -4; _hw_input_s0_x < -4 + 2488; _hw_input_s0_x++)
   {
    // Provision buffer _hw_input_stencil
    int32_t _305 = _halide_buffer_get_stride(_input_buffer, 1);
    int32_t _306 = _305 * _hw_input_s0_y;
    int32_t _307 = _305 * 4;
    int32_t _308 = _halide_buffer_get_min(_input_buffer, 0);
    int32_t _309 = _307 - _308;
    int32_t _310 = _halide_buffer_get_min(_input_buffer, 1);
    int32_t _311 = _310 * _305;
    int32_t _312 = _309 - _311;
    int32_t _313 = _306 + _312;
    int32_t _314 = _313 + _hw_input_s0_x;
    int32_t _315 = _314 + 4;
    uint16_t _316 = ((const uint16_t *)_input)[_315];
_316;
    uint16_t *_hw_input_stencil_host = (uint16_t *) _hw_input_stencil->host_ptr;
    int32_t _317 = _hw_input_s0_y * 4720;
    int32_t _318 = _317 + _hw_input_s0_x;
    int32_t _319 = _318 + 18884;
_319;
    _hw_input_stencil_host[_319] = _316;
   } // for _hw_input_s0_x
  } // for _hw_input_s0_y
  // consume hw_input.stencil
  // Allocate shared buffer for _hw_output_global_wrapper_stencil
  RDAI_MemObject *_hw_output_global_wrapper_stencil = RDAI_mem_shared_allocate(27379200);
  // produce hw_output_global_wrapper.stencil
  for (int _hw_output_global_wrapper_s0_y_yo = 0; _hw_output_global_wrapper_s0_y_yo < 0 + 10; _hw_output_global_wrapper_s0_y_yo++)
  {
   int32_t _320 = _hw_output_global_wrapper_s0_y_yo * 92;
   int32_t _321 = _hw_output_global_wrapper_s0_y_yo * 184;
   for (int _hw_output_global_wrapper_s0_x_xo = 0; _hw_output_global_wrapper_s0_x_xo < 0 + 10; _hw_output_global_wrapper_s0_x_xo++)
   {
    // produce _hls_accelerator.hw_output_global_wrapper
    RDAI_MemObject* _320_obj = RDAI_mem_shared_allocate(1);
    int32_t *_320_obj_host = ( int32_t*) _320_obj->host_ptr;
    _320_obj_host[0] = (int32_t) _320;
    RDAI_MemObject* _321_obj = RDAI_mem_shared_allocate(1);
    int32_t *_321_obj_host = ( int32_t*) _321_obj->host_ptr;
    _321_obj_host[0] = (int32_t) _321;
    RDAI_MemObject* _hw_output_global_wrapper_s0_x_xo_obj = RDAI_mem_shared_allocate(1);
    int32_t *_hw_output_global_wrapper_s0_x_xo_obj_host = ( int32_t*) _hw_output_global_wrapper_s0_x_xo_obj->host_ptr;
    _hw_output_global_wrapper_s0_x_xo_obj_host[0] = (int32_t) _hw_output_global_wrapper_s0_x_xo;
    ...
    RDAI_VLNV device_vlnv = {{"aha"}, {"halide_hardware"}, {"camera_pipeline_shared"}, 1};
    RDAI_Device **devices = RDAI_get_devices_with_vlnv(platforms[0], &device_vlnv);
    assert(devices && devices[0]);
    RDAI_MemObject *mem_obj_list[6] = {
        _320_obj,
        _321_obj,
        _hw_input_stencil,
        _hw_output_global_wrapper_s0_x_xo_obj,
   ...
   } // for _hw_output_global_wrapper_s0_x_xo
  } // for _hw_output_global_wrapper_s0_y_yo
  // consume hw_output_global_wrapper.stencil
  int32_t _8632 = _halide_buffer_get_min(_output_buffer, 1);
  bool _8633 = 0 <= _8632;
  int32_t _8634 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _8635 = _8634 + _8632;
  bool _8636 = _8635 <= 1840;
  bool _8637 = _8633 && _8636;
  if (!_8637)   {
   int32_t _8638 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _8639 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _8640 = _8639 + _8638;
   int32_t _8641 = _8640 + -1;
   int32_t _8642 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 1839, _8638, _8641);
   return _8642;
  }
  int32_t _8643 = _halide_buffer_get_min(_output_buffer, 0);
  bool _8644 = 0 <= _8643;
  int32_t _8645 = _halide_buffer_get_extent(_output_buffer, 0);
  int32_t _8646 = _8645 + _8643;
  bool _8647 = _8646 <= 2480;
  bool _8648 = _8644 && _8647;
  if (!_8648)   {
   int32_t _8649 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _8650 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _8651 = _8650 + _8649;
   int32_t _8652 = _8651 + -1;
   int32_t _8653 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 2479, _8649, _8652);
   return _8653;
  }
  int32_t _8654 = _halide_buffer_get_min(_output_buffer, 2);
  bool _8655 = 0 <= _8654;
  int32_t _8656 = _halide_buffer_get_extent(_output_buffer, 2);
  int32_t _8657 = _8656 + _8654;
  bool _8658 = _8657 <= 3;
  bool _8659 = _8655 && _8658;
  if (!_8659)   {
   int32_t _8660 = _halide_buffer_get_min(_output_buffer, 2);
   int32_t _8661 = _halide_buffer_get_extent(_output_buffer, 2);
   int32_t _8662 = _8661 + _8660;
   int32_t _8663 = _8662 + -1;
   int32_t _8664 = halide_error_explicit_bounds_too_small(_ucon, "c", "output", 0, 2, _8660, _8663);
   return _8664;
  }
  // produce output
  for (int _output_s0_c = 0; _output_s0_c < 0 + 3; _output_s0_c++)
  {
   for (int _output_s0_y = 0; _output_s0_y < 0 + 1840; _output_s0_y++)
   {
    for (int _output_s0_x = 0; _output_s0_x < 0 + 2480; _output_s0_x++)
    {
     int32_t _8665 = _output_s0_y * 7440;
     int32_t _8666 = _output_s0_x * 3;
     int32_t _8667 = _8666 + _output_s0_c;
     int32_t _8668 = _8665 + _8667;
_8668;
     uint16_t *_hw_output_global_wrapper_stencil_host = (uint16_t *) _hw_output_global_wrapper_stencil->host_ptr;
     uint16_t _8669 = _hw_output_global_wrapper_stencil_host[_8668];
     uint8_t _8670 = (uint8_t)(_8669);
     int32_t _8671 = _halide_buffer_get_stride(_output_buffer, 2);
     int32_t _8672 = _8671 * _output_s0_c;
     int32_t _8673 = _halide_buffer_get_stride(_output_buffer, 1);
     int32_t _8674 = _8673 * _output_s0_y;
     int32_t _8675 = _8672 + _8674;
     int32_t _8676 = _8675 + _output_s0_x;
     ((uint8_t *)_output)[_8676] = _8670;
    } // for _output_s0_x
   } // for _output_s0_y
  } // for _output_s0_c
