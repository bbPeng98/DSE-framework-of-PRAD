...
int multi_channel_conv_clockwork(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
 ...
 if (_25)
 {
  ...
  for (int _hw_input_s0_y = 0; _hw_input_s0_y < 0 + 64; _hw_input_s0_y++)
  {
   for (int _hw_input_s0_x = 0; _hw_input_s0_x < 0 + 64; _hw_input_s0_x++)
   {
    ...
    int32_t _307 = _halide_buffer_get_min(_input_buffer, 0);
    int32_t _308 = _halide_buffer_get_min(_input_buffer, 1);
    int32_t _309 = _308 * _305;
    int32_t _310 = _307 + _309;
    int32_t _311 = _306 - _310;
    int32_t _312 = _311 + _hw_input_s0_x;
    uint8_t _313 = ((const uint8_t *)_input)[_312];
    uint16_t _314 = (uint16_t)(_313);
_314;
    uint16_t *_hw_input_stencil_host = (uint16_t *) _hw_input_stencil->host_ptr;
    int32_t _315 = _hw_input_s0_y * 64;
    int32_t _316 = _315 + _hw_input_s0_x;
_316;
    _hw_input_stencil_host[_316] = _314;
   } // for _hw_input_s0_x
  } // for _hw_input_s0_y
  // consume hw_input.stencil
  // Allocate shared buffer for _hw_output_stencil
  RDAI_MemObject *_hw_output_stencil = RDAI_mem_shared_allocate(23064);
  ...
  RDAI_VLNV device_vlnv = {{"aha"}, {"halide_hardware"}, {"multi_channel_conv"}, 1};
  ...
  int32_t _518 = _halide_buffer_get_min(_output_buffer, 2);
  bool _519 = 0 <= _518;
  int32_t _520 = _halide_buffer_get_extent(_output_buffer, 2);
  int32_t _521 = _520 + _518;
  bool _522 = _521 <= 3;
  bool _523 = _519 && _522;
  if (!_523)   {
   int32_t _524 = _halide_buffer_get_min(_output_buffer, 2);
   int32_t _525 = _halide_buffer_get_extent(_output_buffer, 2);
   int32_t _526 = _525 + _524;
   int32_t _527 = _526 + -1;
   int32_t _528 = halide_error_explicit_bounds_too_small(_ucon, "z", "output", 0, 2, _524, _527);
   return _528;
  }
  int32_t _529 = _halide_buffer_get_min(_output_buffer, 1);
  bool _530 = 0 <= _529;
  int32_t _531 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _532 = _531 + _529;
  bool _533 = _532 <= 62;
  bool _534 = _530 && _533;
  if (!_534)   {
   int32_t _535 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _536 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _537 = _536 + _535;
   int32_t _538 = _537 + -1;
   int32_t _539 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 61, _535, _538);
   return _539;
  }
  int32_t _540 = _halide_buffer_get_min(_output_buffer, 0);
  bool _541 = 0 <= _540;
  int32_t _542 = _halide_buffer_get_extent(_output_buffer, 0);
  int32_t _543 = _542 + _540;
  bool _544 = _543 <= 62;
  bool _545 = _541 && _544;
  if (!_545)   {
   int32_t _546 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _547 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _548 = _547 + _546;
   int32_t _549 = _548 + -1;
   int32_t _550 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 61, _546, _549);
   return _550;
  }
  // produce output
  for (int _output_s0_z = 0; _output_s0_z < 0 + 3; _output_s0_z++)
  {
   for (int _output_s0_y = 0; _output_s0_y < 0 + 62; _output_s0_y++)
   {
    for (int _output_s0_x = 0; _output_s0_x < 0 + 62; _output_s0_x++)
    {
     int32_t _551 = _output_s0_z * 3844;
     int32_t _552 = _output_s0_y * 62;
     int32_t _553 = _552 + _output_s0_x;
     int32_t _554 = _551 + _553;
_554;
     uint16_t *_hw_output_stencil_host = (uint16_t *) _hw_output_stencil->host_ptr;
     uint16_t _555 = _hw_output_stencil_host[_554];
     uint8_t _556 = (uint8_t)(_555);
     int32_t _557 = _halide_buffer_get_stride(_output_buffer, 2);
     int32_t _558 = _557 * _output_s0_z;
     int32_t _559 = _halide_buffer_get_stride(_output_buffer, 1);
     int32_t _560 = _559 * _output_s0_y;
     int32_t _561 = _558 + _560;
     int32_t _562 = _561 + _output_s0_x;
     ((uint8_t *)_output)[_562] = _556;
    } // for _output_s0_x
   } // for _output_s0_y
  } // for _output_s0_z
