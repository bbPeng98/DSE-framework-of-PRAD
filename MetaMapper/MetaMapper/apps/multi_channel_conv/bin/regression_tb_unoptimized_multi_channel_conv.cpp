...
int main() {
  srand(234);
  ofstream fout("regression_result_unoptimized_multi_channel_conv.txt");
  ...
  unoptimized_multi_channel_conv(hw_input_stencil, hw_output_stencil);
  for (int i = 0; i < 11532; i++) {
