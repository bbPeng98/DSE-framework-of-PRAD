...
int main(int argc, char **argv) {
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(3, op_hcompute_hw_input_global_wrapper_stencil_1_read_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(4, op_hcompute_hw_input_global_wrapper_stencil_2_read_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(5, op_hcompute_hw_input_global_wrapper_stencil_read_pipe0_ocl_buf));

  uint64_t transfer_size = num_epochs*(0 / 1);
  OCL_CHECK(err, err = krnl_vector_add.setArg(6, transfer_size));

  std::cout << "Migrating memory" << std::endl;
  OCL_CHECK(err, err = q.enqueueMigrateMemObjects({op_hcompute_hw_input_global_wrapper_stencil_1_read_pipe0_ocl_buf, op_hcompute_hw_input_global_wrapper_stencil_2_read_pipe0_ocl_buf, op_hcompute_hw_input_global_wrapper_stencil_read_pipe0_ocl_buf}, 0));
