#ifndef HALIDE_____bin___boolean_ops_h
#define HALIDE_____bin___boolean_ops_h
#include <stdint.h>
...
int boolean_ops(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int boolean_ops_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *boolean_ops_metadata() HALIDE_FUNCTION_ATTRS;
