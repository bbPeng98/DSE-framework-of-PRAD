...
int boolean_ops_clockwork(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
...
_255;
  ...
  RDAI_VLNV device_vlnv = {{"aha"}, {"halide_hardware"}, {"boolean_ops"}, 1};
  ...
  int32_t _285 = _halide_buffer_get_min(_output_buffer, 1);
  bool _286 = 0 <= _285;
  int32_t _287 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _288 = _287 + _285;
  bool _289 = _288 <= 64;
  bool _290 = _286 && _289;
  if (!_290)   {
   int32_t _291 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _292 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _293 = _292 + _291;
   int32_t _294 = _293 + -1;
   int32_t _295 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 63, _291, _294);
   return _295;
  }
  int32_t _296 = _halide_buffer_get_min(_output_buffer, 0);
  bool _297 = 0 <= _296;
  ...
  bool _301 = _297 && _300;
  if (!_301)   {
   int32_t _302 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _303 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _304 = _303 + _302;
   int32_t _305 = _304 + -1;
   int32_t _306 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 63, _302, _305);
   return _306;
  }
  // produce output
  for (int _output_s0_y = 0; _output_s0_y < 0 + 64; _output_s0_y++)
  {
   ...
   {
    int32_t _307 = _output_s0_y * 64;
    int32_t _308 = _307 + _output_s0_x;
_308;
    int16_t *_hw_output_stencil_host = (int16_t *) _hw_output_stencil->host_ptr;
    int16_t _309 = _hw_output_stencil_host[_308];
    uint8_t _310 = (uint8_t)(_309);
    int32_t _311 = _halide_buffer_get_stride(_output_buffer, 1);
    int32_t _312 = _311 * _output_s0_y;
    int32_t _313 = _312 + _output_s0_x;
    ((uint8_t *)_output)[_313] = _310;
   } // for _output_s0_x
  } // for _output_s0_y
