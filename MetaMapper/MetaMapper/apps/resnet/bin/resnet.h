#ifndef HALIDE_____bin___resnet_h
#define HALIDE_____bin___resnet_h
#include <stdint.h>
...
int resnet(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_kernel_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int resnet_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *resnet_metadata() HALIDE_FUNCTION_ATTRS;
