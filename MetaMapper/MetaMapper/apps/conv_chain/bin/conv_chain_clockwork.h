#ifndef HALIDE_____bin___conv_chain_clockwork_h
#define HALIDE_____bin___conv_chain_clockwork_h
#include <stdint.h>
...
int conv_chain_clockwork_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *conv_chain_clockwork_metadata() HALIDE_FUNCTION_ATTRS;
