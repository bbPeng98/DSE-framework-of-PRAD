...
int scomp_clockwork(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
 ...
 if (_8)
 {
  ...
  struct halide_buffer_t *_14 = _halide_buffer_init(_input_buffer, _9, _11, _10, _12, 0, 8, 2, _13, _10);
  (void)_14;
 } // if _8
 ...
 if (_15)
 {
  ...
  struct halide_buffer_t *_21 = _halide_buffer_init(_output_buffer, _16, _18, _17, _19, 0, 8, 2, _20, _17);
  (void)_21;
 } // if _15
 ...
 if (_25)
 {
  ...
  uint32_t _27 = (uint32_t)(67584);
  bool _28 = _26 == _27;
  if (!_28)   {
   uint32_t _29 = _halide_buffer_get_type(_input_buffer);
   uint32_t _30 = (uint32_t)(67584);
  ...
  uint32_t _37 = (uint32_t)(67584);
  bool _38 = _36 == _37;
  if (!_38)   {
   uint32_t _39 = _halide_buffer_get_type(_output_buffer);
   uint32_t _40 = (uint32_t)(67584);
  ...
  for (int _hw_input_s0_y = 0; _hw_input_s0_y < 0 + 64; _hw_input_s0_y++)
  {
   for (int _hw_input_s0_x = 0; _hw_input_s0_x < 0 + 64; _hw_input_s0_x++)
   {
    ...
    int8_t _252 = ((const int8_t *)_input)[_251];
    int16_t _253 = (int16_t)(_252);
_253;
...
_255;
  ...
  RDAI_VLNV device_vlnv = {{"aha"}, {"halide_hardware"}, {"scomp"}, 1};
  ...
  bool _301 = 0 <= _300;
  int32_t _302 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _303 = _302 + _300;
  bool _304 = _303 <= 64;
  bool _305 = _301 && _304;
  if (!_305)   {
   int32_t _306 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _307 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _308 = _307 + _306;
   int32_t _309 = _308 + -1;
   int32_t _310 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 63, _306, _309);
   return _310;
  }
  int32_t _311 = _halide_buffer_get_min(_output_buffer, 0);
  bool _312 = 0 <= _311;
  int32_t _313 = _halide_buffer_get_extent(_output_buffer, 0);
  int32_t _314 = _313 + _311;
  bool _315 = _314 <= 64;
  bool _316 = _312 && _315;
  if (!_316)   {
   int32_t _317 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _318 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _319 = _318 + _317;
   int32_t _320 = _319 + -1;
   int32_t _321 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 63, _317, _320);
   return _321;
  }
  // produce output
  for (int _output_s0_y = 0; _output_s0_y < 0 + 64; _output_s0_y++)
  {
   ...
   {
    int32_t _322 = _output_s0_y * 64;
    int32_t _323 = _322 + _output_s0_x;
_323;
    int16_t *_hw_output_stencil_host = (int16_t *) _hw_output_stencil->host_ptr;
    int16_t _324 = _hw_output_stencil_host[_323];
    int8_t _325 = (int8_t)(_324);
    int32_t _326 = _halide_buffer_get_stride(_output_buffer, 1);
    int32_t _327 = _326 * _output_s0_y;
    int32_t _328 = _327 + _output_s0_x;
    ((int8_t *)_output)[_328] = _325;
   } // for _output_s0_x
  } // for _output_s0_y
