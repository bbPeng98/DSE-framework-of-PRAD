#ifndef HALIDE_____bin___mem_unbuffered_clockwork_h
#define HALIDE_____bin___mem_unbuffered_clockwork_h
#include <stdint.h>
...
int mem_unbuffered_clockwork_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *mem_unbuffered_clockwork_metadata() HALIDE_FUNCTION_ATTRS;
