...
//store is: hw_input_global_wrapper.glb.stencil(0, (hw_input_global_wrapper_s0_x_x*2), ((hw_input_global_wrapper_s0_y + -3) + 3)) = hw_input.stencil(0, (((hw_input_global_wrapper_s0_x_x + (0*61))*2) + -3), (hw_input_global_wrapper_s0_y + -3))
...
//store is: hw_input_global_wrapper.glb.stencil(1, (hw_input_global_wrapper_s0_x_x*2), ((hw_input_global_wrapper_s0_y + -3) + 3)) = hw_input.stencil(1, (((hw_input_global_wrapper_s0_x_x + (0*61))*2) + -3), (hw_input_global_wrapper_s0_y + -3))
...
//store is: hw_input_global_wrapper.glb.stencil(2, (hw_input_global_wrapper_s0_x_x*2), ((hw_input_global_wrapper_s0_y + -3) + 3)) = hw_input.stencil(2, (((hw_input_global_wrapper_s0_x_x + (0*61))*2) + -3), (hw_input_global_wrapper_s0_y + -3))
...
//store is: hw_input_global_wrapper.glb.stencil(0, ((hw_input_global_wrapper_s0_x_x*2) + 1), ((hw_input_global_wrapper_s0_y + -3) + 3)) = hw_input.stencil(0, (((hw_input_global_wrapper_s0_x_x + (0*61))*2) + -2), (hw_input_global_wrapper_s0_y + -3))
...
//store is: hw_input_global_wrapper.glb.stencil(1, ((hw_input_global_wrapper_s0_x_x*2) + 1), ((hw_input_global_wrapper_s0_y + -3) + 3)) = hw_input.stencil(1, (((hw_input_global_wrapper_s0_x_x + (0*61))*2) + -2), (hw_input_global_wrapper_s0_y + -3))
...
//store is: hw_input_global_wrapper.glb.stencil(2, ((hw_input_global_wrapper_s0_x_x*2) + 1), ((hw_input_global_wrapper_s0_y + -3) + 3)) = hw_input.stencil(2, (((hw_input_global_wrapper_s0_x_x + (0*61))*2) + -2), (hw_input_global_wrapper_s0_y + -3))
...
hw_uint<16> hcompute_hw_output_glb_stencil(hw_uint<144>& cim_stencil) {
  ...
  int16_t _1334 = (int16_t)(255);
  int16_t _1335 = (int16_t)(0);
  bool _1336 = _cim_stencil_1 < _cim_stencil_2;
  bool _1337 = _cim_stencil_3 < _cim_stencil_2;
  bool _1338 = _1336 && _1337;
  bool _1339 = _cim_stencil_4 < _cim_stencil_2;
  bool _1340 = _1338 && _1339;
  bool _1341 = _cim_stencil_5 < _cim_stencil_2;
  bool _1342 = _1340 && _1341;
  bool _1343 = _cim_stencil_6 < _cim_stencil_2;
  bool _1344 = _1342 && _1343;
  bool _1345 = _cim_stencil_7 < _cim_stencil_2;
  bool _1346 = _1344 && _1345;
  bool _1347 = _cim_stencil_8 < _cim_stencil_2;
  bool _1348 = _1346 && _1347;
  bool _1349 = _cim_stencil_9 < _cim_stencil_2;
  bool _1350 = _1348 && _1349;
  int16_t _1351 = (int16_t)(1);
  bool _1352 = _1351 <= _cim_stencil_2;
  bool _1353 = _1350 && _1352;
  int16_t _1354 = (int16_t)(_1353 ? _1334 : _1335);
  return _1354;
}

//store is: hw_output.glb.stencil(((hw_output_s0_x_xi_xi*2) + 1), hw_output_s0_y_yi) = select((((((((((cim.stencil(((hw_output_s0_x_xi_xi*2) + 1), hw_output_s0_y_yi) < cim.stencil(((hw_output_s0_x_xi_xi*2) + 2), (hw_output_s0_y_yi + 1))) && (cim.stencil(((hw_output_s0_x_xi_xi*2) + 2), hw_output_s0_y_yi) < cim.stencil(((hw_output_s0_x_xi_xi*2) + 2), (hw_output_s0_y_yi + 1)))) && (cim.stencil(((hw_output_s0_x_xi_xi*2) + 3), hw_output_s0_y_yi) < cim.stencil(((hw_output_s0_x_xi_xi*2) + 2), (hw_output_s0_y_yi + 1)))) && (cim.stencil(((hw_output_s0_x_xi_xi*2) + 1), (hw_output_s0_y_yi + 1)) < cim.stencil(((hw_output_s0_x_xi_xi*2) + 2), (hw_output_s0_y_yi + 1)))) && (cim.stencil(((hw_output_s0_x_xi_xi*2) + 3), (hw_output_s0_y_yi + 1)) < cim.stencil(((hw_output_s0_x_xi_xi*2) + 2), (hw_output_s0_y_yi + 1)))) && (cim.stencil(((hw_output_s0_x_xi_xi*2) + 1), (hw_output_s0_y_yi + 2)) < cim.stencil(((hw_output_s0_x_xi_xi*2) + 2), (hw_output_s0_y_yi + 1)))) && (cim.stencil(((hw_output_s0_x_xi_xi*2) + 2), (hw_output_s0_y_yi + 2)) < cim.stencil(((hw_output_s0_x_xi_xi*2) + 2), (hw_output_s0_y_yi + 1)))) && (cim.stencil(((hw_output_s0_x_xi_xi*2) + 3), (hw_output_s0_y_yi + 2)) < cim.stencil(((hw_output_s0_x_xi_xi*2) + 2), (hw_output_s0_y_yi + 1)))) && ((int16)1 <= cim.stencil(((hw_output_s0_x_xi_xi*2) + 2), (hw_output_s0_y_yi + 1)))), (int16)255, (int16)0)
hw_uint<16> hcompute_hw_output_glb_stencil_1(hw_uint<144>& cim_stencil) {
  ...
  int16_t _1411 = (int16_t)(255);
  int16_t _1412 = (int16_t)(0);
  bool _1413 = _cim_stencil_10 < _cim_stencil_11;
  bool _1414 = _cim_stencil_12 < _cim_stencil_11;
  bool _1415 = _1413 && _1414;
  bool _1416 = _cim_stencil_13 < _cim_stencil_11;
  bool _1417 = _1415 && _1416;
  bool _1418 = _cim_stencil_14 < _cim_stencil_11;
  bool _1419 = _1417 && _1418;
  bool _1420 = _cim_stencil_15 < _cim_stencil_11;
  bool _1421 = _1419 && _1420;
  bool _1422 = _cim_stencil_16 < _cim_stencil_11;
  bool _1423 = _1421 && _1422;
  bool _1424 = _cim_stencil_17 < _cim_stencil_11;
  bool _1425 = _1423 && _1424;
  bool _1426 = _cim_stencil_18 < _cim_stencil_11;
  bool _1427 = _1425 && _1426;
  int16_t _1428 = (int16_t)(1);
  bool _1429 = _1428 <= _cim_stencil_11;
  bool _1430 = _1427 && _1429;
  int16_t _1431 = (int16_t)(_1430 ? _1411 : _1412);
  return _1431;
}

//store is: hw_output_global_wrapper.stencil(((hw_output_global_wrapper_s0_x_xi_xi + (0*61))*2), (hw_output_global_wrapper_s0_y_yi + 0)) = hw_output.glb.stencil((hw_output_global_wrapper_s0_x_xi_xi*2), hw_output_global_wrapper_s0_y_yi)
...
//store is: hw_output_global_wrapper.stencil((((hw_output_global_wrapper_s0_x_xi_xi + (0*61))*2) + 1), (hw_output_global_wrapper_s0_y_yi + 0)) = hw_output.glb.stencil(((hw_output_global_wrapper_s0_x_xi_xi*2) + 1), hw_output_global_wrapper_s0_y_yi)
