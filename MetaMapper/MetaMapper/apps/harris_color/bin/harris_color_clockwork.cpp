...
int harris_color_clockwork(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
 ...
 if (_25)
 {
  ...
  if (!_51)   {
   ...
   int32_t _54 = _53 + _52;
   int32_t _55 = _54 + -1;
   int32_t _56 = halide_error_access_out_of_bounds(_ucon, "Input buffer input", 0, 0, 615, _52, _55);
   return _56;
  }
  ...
  if (!_66)   {
   ...
   int32_t _69 = _68 + _67;
   int32_t _70 = _69 + -1;
   int32_t _71 = halide_error_access_out_of_bounds(_ucon, "Input buffer input", 1, 0, 2555, _67, _70);
   return _71;
  }
  ...
  if (!_81)   {
   ...
   int32_t _84 = _83 + _82;
   int32_t _85 = _84 + -1;
   int32_t _86 = halide_error_access_out_of_bounds(_ucon, "Input buffer input", 2, 0, 2, _82, _85);
   return _86;
  }
  ...
  if (!_96)   {
   ...
   int32_t _99 = _98 + _97;
   int32_t _100 = _99 + -1;
   int32_t _101 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 0, 0, 609, _97, _100);
   return _101;
  }
  ...
  if (!_111)   {
   ...
   int32_t _115 = _114 + -1;
   int32_t _116 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 1, 0, 2549, _112, _115);
   return _116;
  }
  ...
  int32_t _189 = _halide_buffer_get_extent(_input_buffer, 2);
  int64_t _190 = (int64_t)(_189);
  int32_t _191 = _halide_buffer_get_stride(_input_buffer, 2);
  int64_t _192 = (int64_t)(_191);
  int64_t _193 = _190 * _192;
  int64_t _194 = (int64_t)(0);
  int64_t _195 = _194 - _193;
  bool _196 = _193 > _194;
  int64_t _197 = (int64_t)(_196 ? _193 : _195);
  uint64_t _198 = (uint64_t)(_197);
  uint64_t _199 = _198;
  uint64_t _200 = (uint64_t)(2147483647);
  bool _201 = _199 <= _200;
  if (!_201)   {
   int32_t _202 = _halide_buffer_get_extent(_input_buffer, 2);
   int64_t _203 = (int64_t)(_202);
   int32_t _204 = _halide_buffer_get_stride(_input_buffer, 2);
   int64_t _205 = (int64_t)(_204);
   int64_t _206 = _203 * _205;
   int64_t _207 = (int64_t)(0);
   int64_t _208 = _207 - _206;
   bool _209 = _206 > _207;
   int64_t _210 = (int64_t)(_209 ? _206 : _208);
   uint64_t _211 = (uint64_t)(_210);
   uint64_t _212 = _211;
   uint64_t _213 = (uint64_t)(2147483647);
   int32_t _214 = halide_error_buffer_allocation_too_large(_ucon, "input", _212, _213);
   return _214;
  }
  int32_t _215 = _halide_buffer_get_extent(_input_buffer, 1);
  int64_t _216 = (int64_t)(_215);
  int32_t _217 = _halide_buffer_get_extent(_input_buffer, 0);
  int64_t _218 = (int64_t)(_217);
  int64_t _219 = _216 * _218;
  int32_t _220 = _halide_buffer_get_extent(_input_buffer, 2);
  int64_t _221 = (int64_t)(_220);
  int64_t _222 = _219 * _221;
  int64_t _223 = (int64_t)(2147483647);
  bool _224 = _222 <= _223;
  if (!_224)   {
   int32_t _225 = _halide_buffer_get_extent(_input_buffer, 1);
   int64_t _226 = (int64_t)(_225);
   int32_t _227 = _halide_buffer_get_extent(_input_buffer, 0);
   int64_t _228 = (int64_t)(_227);
   int64_t _229 = _226 * _228;
   int32_t _230 = _halide_buffer_get_extent(_input_buffer, 2);
   int64_t _231 = (int64_t)(_230);
   int64_t _232 = _229 * _231;
   int64_t _233 = (int64_t)(2147483647);
   int32_t _234 = halide_error_buffer_extents_too_large(_ucon, "input", _232, _233);
   return _234;
  }
  int32_t _235 = _halide_buffer_get_extent(_output_buffer, 0);
  ...
  bool _244 = _242 <= _243;
  if (!_244)   {
   int32_t _245 = _halide_buffer_get_extent(_output_buffer, 0);
  ...
  int32_t _257 = _halide_buffer_get_stride(_output_buffer, 1);
  int64_t _258 = (int64_t)(_257);
  int64_t _259 = _256 * _258;
  int64_t _260 = (int64_t)(0);
  int64_t _261 = _260 - _259;
  bool _262 = _259 > _260;
  int64_t _263 = (int64_t)(_262 ? _259 : _261);
  uint64_t _264 = (uint64_t)(_263);
  uint64_t _265 = _264;
  uint64_t _266 = (uint64_t)(2147483647);
  bool _267 = _265 <= _266;
  if (!_267)   {
   int32_t _268 = _halide_buffer_get_extent(_output_buffer, 1);
   int64_t _269 = (int64_t)(_268);
   int32_t _270 = _halide_buffer_get_stride(_output_buffer, 1);
   int64_t _271 = (int64_t)(_270);
   int64_t _272 = _269 * _271;
   int64_t _273 = (int64_t)(0);
   int64_t _274 = _273 - _272;
   bool _275 = _272 > _273;
   int64_t _276 = (int64_t)(_275 ? _272 : _274);
   uint64_t _277 = (uint64_t)(_276);
   uint64_t _278 = _277;
   uint64_t _279 = (uint64_t)(2147483647);
   int32_t _280 = halide_error_buffer_allocation_too_large(_ucon, "output", _278, _279);
   return _280;
  }
  int32_t _281 = _halide_buffer_get_extent(_output_buffer, 1);
  int64_t _282 = (int64_t)(_281);
  int32_t _283 = _halide_buffer_get_extent(_output_buffer, 0);
  int64_t _284 = (int64_t)(_283);
  int64_t _285 = _282 * _284;
  int64_t _286 = (int64_t)(2147483647);
  bool _287 = _285 <= _286;
  if (!_287)   {
   int32_t _288 = _halide_buffer_get_extent(_output_buffer, 1);
   int64_t _289 = (int64_t)(_288);
   int32_t _290 = _halide_buffer_get_extent(_output_buffer, 0);
  ...
  RDAI_MemObject *_hw_input_stencil = RDAI_mem_shared_allocate(16930944);
  // produce hw_input.stencil
  for (int _hw_input_s0_y = -3; _hw_input_s0_y < -3 + 2556; _hw_input_s0_y++)
  {
   for (int _hw_input_s0_x = -3; _hw_input_s0_x < -3 + 616; _hw_input_s0_x++)
   {
    for (int _hw_input_s0_c = 0; _hw_input_s0_c < 0 + 3; _hw_input_s0_c++)
    {
     // Provision buffer _hw_input_stencil
     int32_t _305 = _halide_buffer_get_stride(_input_buffer, 2);
     int32_t _306 = _305 * _hw_input_s0_c;
     int32_t _307 = _halide_buffer_get_stride(_input_buffer, 1);
     int32_t _308 = _307 * _hw_input_s0_y;
     int32_t _309 = _307 * 3;
     int32_t _310 = _halide_buffer_get_min(_input_buffer, 2);
     int32_t _311 = _310 * _305;
     int32_t _312 = _309 - _311;
     int32_t _313 = _halide_buffer_get_min(_input_buffer, 0);
     int32_t _314 = _312 - _313;
     int32_t _315 = _halide_buffer_get_min(_input_buffer, 1);
     int32_t _316 = _315 * _307;
     int32_t _317 = _314 - _316;
     int32_t _318 = _308 + _317;
     int32_t _319 = _318 + _hw_input_s0_x;
     int32_t _320 = _306 + _319;
     int32_t _321 = _320 + 3;
     uint8_t _322 = ((const uint8_t *)_input)[_321];
     int16_t _323 = (int16_t)(_322);
_323;
     int16_t *_hw_input_stencil_host = (int16_t *) _hw_input_stencil->host_ptr;
     int32_t _324 = _hw_input_s0_y * 3312;
     int32_t _325 = _hw_input_s0_x * 3;
     int32_t _326 = _325 + _hw_input_s0_c;
     int32_t _327 = _324 + _326;
     int32_t _328 = _327 + 9945;
_328;
     _hw_input_stencil_host[_328] = _323;
    } // for _hw_input_s0_c
   } // for _hw_input_s0_x
  } // for _hw_input_s0_y
  // consume hw_input.stencil
  // Allocate shared buffer for _hw_output_global_wrapper_stencil
  RDAI_MemObject *_hw_output_global_wrapper_stencil = RDAI_mem_shared_allocate(3111000);
  ...
  {
   int32_t _329 = _hw_output_global_wrapper_s0_y_yo * 255;
   for (int _hw_output_global_wrapper_s0_x_xo = 0; _hw_output_global_wrapper_s0_x_xo < 0 + 5; _hw_output_global_wrapper_s0_x_xo++)
   {
    // produce _hls_accelerator.hw_output_global_wrapper
    RDAI_MemObject* _329_obj = RDAI_mem_shared_allocate(1);
    int32_t *_329_obj_host = ( int32_t*) _329_obj->host_ptr;
    _329_obj_host[0] = (int32_t) _329;
    ...
    RDAI_VLNV device_vlnv = {{"aha"}, {"halide_hardware"}, {"harris_color"}, 1};
  ...
  int32_t _1503 = _halide_buffer_get_min(_output_buffer, 1);
  bool _1504 = 0 <= _1503;
  int32_t _1505 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _1506 = _1505 + _1503;
  bool _1507 = _1506 <= 2550;
  bool _1508 = _1504 && _1507;
  if (!_1508)   {
   int32_t _1509 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _1510 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _1511 = _1510 + _1509;
   int32_t _1512 = _1511 + -1;
   int32_t _1513 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 2549, _1509, _1512);
   return _1513;
  }
  int32_t _1514 = _halide_buffer_get_min(_output_buffer, 0);
  bool _1515 = 0 <= _1514;
  int32_t _1516 = _halide_buffer_get_extent(_output_buffer, 0);
  int32_t _1517 = _1516 + _1514;
  bool _1518 = _1517 <= 610;
  bool _1519 = _1515 && _1518;
  if (!_1519)   {
   int32_t _1520 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _1521 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _1522 = _1521 + _1520;
   int32_t _1523 = _1522 + -1;
   int32_t _1524 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 609, _1520, _1523);
   return _1524;
  }
  // produce output
  for (int _output_s0_y = 0; _output_s0_y < 0 + 2550; _output_s0_y++)
  {
   for (int _output_s0_x = 0; _output_s0_x < 0 + 610; _output_s0_x++)
   {
    int32_t _1525 = _output_s0_y * 610;
    int32_t _1526 = _1525 + _output_s0_x;
_1526;
    int16_t *_hw_output_global_wrapper_stencil_host = (int16_t *) _hw_output_global_wrapper_stencil->host_ptr;
    int16_t _1527 = _hw_output_global_wrapper_stencil_host[_1526];
    uint8_t _1528 = (uint8_t)(_1527);
    int32_t _1529 = _halide_buffer_get_stride(_output_buffer, 1);
    int32_t _1530 = _1529 * _output_s0_y;
    int32_t _1531 = _1530 + _output_s0_x;
    ((uint8_t *)_output)[_1531] = _1528;
   } // for _output_s0_x
  } // for _output_s0_y
