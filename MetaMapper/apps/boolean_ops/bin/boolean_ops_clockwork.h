#ifndef HALIDE_____bin___boolean_ops_clockwork_h
#define HALIDE_____bin___boolean_ops_clockwork_h
#include <stdint.h>
...
int boolean_ops_clockwork_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *boolean_ops_clockwork_metadata() HALIDE_FUNCTION_ATTRS;
