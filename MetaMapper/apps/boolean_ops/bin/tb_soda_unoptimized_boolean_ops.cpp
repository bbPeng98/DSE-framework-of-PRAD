// AUTO GEN SODA TB
#include "unoptimized_boolean_ops_kernel.h"
#include <iostream>
#include <fstream>
...
int main() {
  ...
  unoptimized_boolean_ops_kernel(hw_output_stencil, hw_input_stencil, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_unoptimized_boolean_ops_regression_result.csv", hw_output_stencil, nrows, ncols, transfer_cols);
