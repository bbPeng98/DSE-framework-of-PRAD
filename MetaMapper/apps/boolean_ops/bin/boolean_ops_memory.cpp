...
prog boolean_ops() {
  prog prg;
  prg.compute_unit_file = "boolean_ops_compute.h";
  prg.name = "boolean_ops";
...
//store is: hw_output.stencil(hw_output_s0_x_xi, hw_output_s0_y_yi) = select(bitwise_xor((((uint16)128 <= hw_input_global_wrapper.stencil(hw_output_s0_x_xi, hw_output_s0_y_yi)) || (hw_input_global_wrapper.stencil(hw_output_s0_x_xi, hw_output_s0_y_yi) < (uint16)64)), ((uint16)128 <= hw_input_global_wrapper.stencil(hw_output_s0_x_xi, hw_output_s0_y_yi))), (int16)200, (int16)0)
