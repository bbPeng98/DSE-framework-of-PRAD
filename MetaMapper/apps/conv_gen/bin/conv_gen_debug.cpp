...
#pragma HLS PIPELINE II=1
 ...
 {
  for (int conv_s1_x_x = 0; conv_s1_x_x < 62; conv_s1_x_x++)
  {
#pragma HLS PIPELINE II=1
   uint16_t _312 = _hw_input_global_wrapper_stencil(_conv_s1_x_x, _conv_s1_y);
   uint16_t _313 = (uint16_t)(17);
   uint16_t _314 = _312 * _313;
   uint16_t _315 = _conv_stencil(_conv_s1_x_x, _conv_s1_y);
   int32_t _316 = _conv_s1_x_x + 1;
   uint16_t _317 = _hw_input_global_wrapper_stencil(_316, _conv_s1_y);
   uint16_t _318 = (uint16_t)(7);
   uint16_t _319 = _317 * _318;
   int32_t _320 = _conv_s1_x_x + 2;
   uint16_t _321 = _hw_input_global_wrapper_stencil(_320, _conv_s1_y);
   uint16_t _322 = (uint16_t)(5);
   uint16_t _323 = _321 * _322;
   int32_t _324 = _conv_s1_y + 1;
   uint16_t _325 = _hw_input_global_wrapper_stencil(_conv_s1_x_x, _324);
   ...
   int32_t _334 = _conv_s1_y + 2;
   uint16_t _335 = _hw_input_global_wrapper_stencil(_conv_s1_x_x, _334);
   ...
   _conv_stencil(_conv_s1_x_x, _conv_s1_y) = _351;
  } // for conv_s1_x_x
 } // for conv_s1_y
