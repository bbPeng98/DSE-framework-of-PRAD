#ifndef HALIDE_____bin___conv_gen_clockwork_h
#define HALIDE_____bin___conv_gen_clockwork_h
#include <stdint.h>
...
int conv_gen_clockwork(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int conv_gen_clockwork_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *conv_gen_clockwork_metadata() HALIDE_FUNCTION_ATTRS;
