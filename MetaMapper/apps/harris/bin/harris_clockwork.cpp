...
int harris_clockwork(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
 ...
 if (_25)
 {
  ...
  if (!_81)   {
   ...
   int32_t _84 = _83 + _82;
   int32_t _85 = _84 + -1;
   int32_t _86 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 0, 0, 57, _82, _85);
   return _86;
  }
  ...
  if (!_96)   {
   ...
   int32_t _99 = _98 + _97;
   int32_t _100 = _99 + -1;
   int32_t _101 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 1, 0, 57, _97, _100);
   return _101;
  }
  ...
  // Allocate shared buffer for _padded16_stencil
  RDAI_MemObject *_padded16_stencil = RDAI_mem_shared_allocate(8192);
  // produce padded16.stencil
  for (int _padded16_s0_y = -3; _padded16_s0_y < -3 + 64; _padded16_s0_y++)
  {
   for (int _padded16_s0_x = -3; _padded16_s0_x < -3 + 64; _padded16_s0_x++)
   {
    // Provision buffer _padded16_stencil
    int32_t _244 = _halide_buffer_get_stride(_input_buffer, 1);
    int32_t _245 = _244 * _padded16_s0_y;
    int32_t _246 = _244 * 3;
    int32_t _247 = _halide_buffer_get_min(_input_buffer, 0);
    int32_t _248 = _246 - _247;
    int32_t _249 = _halide_buffer_get_min(_input_buffer, 1);
    int32_t _250 = _249 * _244;
    int32_t _251 = _248 - _250;
    int32_t _252 = _245 + _251;
    int32_t _253 = _252 + _padded16_s0_x;
    int32_t _254 = _253 + 3;
    uint8_t _255 = ((const uint8_t *)_input)[_254];
    int16_t _256 = (int16_t)(_255);
_256;
    int16_t *_padded16_stencil_host = (int16_t *) _padded16_stencil->host_ptr;
    int32_t _257 = _padded16_s0_y * 64;
    int32_t _258 = _257 + _padded16_s0_x;
    int32_t _259 = _258 + 195;
_259;
    _padded16_stencil_host[_259] = _256;
   } // for _padded16_s0_x
  } // for _padded16_s0_y
  // consume padded16.stencil
  // Allocate shared buffer for _hw_output_stencil
  RDAI_MemObject *_hw_output_stencil = RDAI_mem_shared_allocate(6728);
  ...
  RDAI_VLNV device_vlnv = {{"aha"}, {"halide_hardware"}, {"harris"}, 1};
  ...
  int32_t _689 = _halide_buffer_get_min(_output_buffer, 1);
  bool _690 = 0 <= _689;
  int32_t _691 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _692 = _691 + _689;
  bool _693 = _692 <= 58;
  bool _694 = _690 && _693;
  if (!_694)   {
   int32_t _695 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _696 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _697 = _696 + _695;
   int32_t _698 = _697 + -1;
   int32_t _699 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 57, _695, _698);
   return _699;
  }
  int32_t _700 = _halide_buffer_get_min(_output_buffer, 0);
  bool _701 = 0 <= _700;
  int32_t _702 = _halide_buffer_get_extent(_output_buffer, 0);
  int32_t _703 = _702 + _700;
  bool _704 = _703 <= 58;
  bool _705 = _701 && _704;
  if (!_705)   {
   int32_t _706 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _707 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _708 = _707 + _706;
   int32_t _709 = _708 + -1;
   int32_t _710 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 57, _706, _709);
   return _710;
  }
  // produce output
  for (int _output_s0_y = 0; _output_s0_y < 0 + 58; _output_s0_y++)
  {
   ...
   {
    int32_t _711 = _output_s0_y * 58;
    int32_t _712 = _711 + _output_s0_x;
_712;
    int16_t *_hw_output_stencil_host = (int16_t *) _hw_output_stencil->host_ptr;
    int16_t _713 = _hw_output_stencil_host[_712];
    uint8_t _714 = (uint8_t)(_713);
    int32_t _715 = _halide_buffer_get_stride(_output_buffer, 1);
    int32_t _716 = _715 * _output_s0_y;
    int32_t _717 = _716 + _output_s0_x;
    ((uint8_t *)_output)[_717] = _714;
   } // for _output_s0_x
  } // for _output_s0_y
  // Free shared buffer for hw_output.stencil
  RDAI_mem_free(_hw_output_stencil);
  // Free shared buffer for padded16.stencil
  RDAI_mem_free(_padded16_stencil);
 } // if _25
 return 0;
}
