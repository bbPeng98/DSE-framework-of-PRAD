#ifndef HALIDE_____bin___mobilenet_h
#define HALIDE_____bin___mobilenet_h
#include <stdint.h>
...
int mobilenet(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_filter_dw_buffer, struct halide_buffer_t *_filter_pw_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int mobilenet_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *mobilenet_metadata() HALIDE_FUNCTION_ATTRS;
