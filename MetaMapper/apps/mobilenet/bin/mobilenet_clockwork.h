#ifndef HALIDE_____bin___mobilenet_clockwork_h
#define HALIDE_____bin___mobilenet_clockwork_h
#include <stdint.h>
...
int mobilenet_clockwork_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *mobilenet_clockwork_metadata() HALIDE_FUNCTION_ATTRS;
