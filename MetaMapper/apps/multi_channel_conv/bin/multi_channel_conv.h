#ifndef HALIDE_____bin___multi_channel_conv_h
#define HALIDE_____bin___multi_channel_conv_h
#include <stdint.h>
...
int multi_channel_conv(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int multi_channel_conv_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *multi_channel_conv_metadata() HALIDE_FUNCTION_ATTRS;
