#ifndef HALIDE_____bin___multi_channel_conv_clockwork_h
#define HALIDE_____bin___multi_channel_conv_clockwork_h
#include <stdint.h>
...
int multi_channel_conv_clockwork_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *multi_channel_conv_clockwork_metadata() HALIDE_FUNCTION_ATTRS;
