#ifndef HALIDE_____bin___brighten_and_blur_h
#define HALIDE_____bin___brighten_and_blur_h
#include <stdint.h>
...
int brighten_and_blur(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int brighten_and_blur_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *brighten_and_blur_metadata() HALIDE_FUNCTION_ATTRS;
