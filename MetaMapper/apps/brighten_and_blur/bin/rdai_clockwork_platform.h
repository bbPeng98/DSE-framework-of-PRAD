...
static RDAI_Device aha_halide_hardware_brighten_and_blur_1 = {
	{ 1 },
	{
		{ "aha" },
		{ "halide_hardware"  },
...
static RDAI_Device *rdai_clockwork_platform_devices[2] = { &aha_halide_hardware_brighten_and_blur_1, NULL };
