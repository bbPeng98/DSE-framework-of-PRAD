...
int brighten_and_blur_clockwork(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
 ...
 if (_25)
 {
  ...
  if (!_81)   {
   ...
   int32_t _84 = _83 + _82;
   int32_t _85 = _84 + -1;
   int32_t _86 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 0, 0, 62, _82, _85);
   return _86;
  }
  ...
  if (!_96)   {
   ...
   int32_t _99 = _98 + _97;
   int32_t _100 = _99 + -1;
   int32_t _101 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 1, 0, 62, _97, _100);
   return _101;
  }
...
_255;
  ...
  RDAI_MemObject *_hw_output_stencil = RDAI_mem_shared_allocate(7938);
  ...
  RDAI_VLNV device_vlnv = {{"aha"}, {"halide_hardware"}, {"brighten_and_blur"}, 1};
  ...
  int32_t _293 = _halide_buffer_get_min(_output_buffer, 1);
  bool _294 = 0 <= _293;
  int32_t _295 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _296 = _295 + _293;
  bool _297 = _296 <= 63;
  bool _298 = _294 && _297;
  if (!_298)   {
   int32_t _299 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _300 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _301 = _300 + _299;
   int32_t _302 = _301 + -1;
   int32_t _303 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 62, _299, _302);
   return _303;
  }
  int32_t _304 = _halide_buffer_get_min(_output_buffer, 0);
  bool _305 = 0 <= _304;
  int32_t _306 = _halide_buffer_get_extent(_output_buffer, 0);
  int32_t _307 = _306 + _304;
  bool _308 = _307 <= 63;
  bool _309 = _305 && _308;
  if (!_309)   {
   int32_t _310 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _311 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _312 = _311 + _310;
   int32_t _313 = _312 + -1;
   int32_t _314 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 62, _310, _313);
   return _314;
  }
  // produce output
  for (int _output_s0_y = 0; _output_s0_y < 0 + 63; _output_s0_y++)
  {
   for (int _output_s0_x = 0; _output_s0_x < 0 + 63; _output_s0_x++)
   {
    int32_t _315 = _output_s0_y * 63;
    int32_t _316 = _315 + _output_s0_x;
_316;
    uint16_t *_hw_output_stencil_host = (uint16_t *) _hw_output_stencil->host_ptr;
    uint16_t _317 = _hw_output_stencil_host[_316];
    uint8_t _318 = (uint8_t)(_317);
    int32_t _319 = _halide_buffer_get_stride(_output_buffer, 1);
    int32_t _320 = _319 * _output_s0_y;
    int32_t _321 = _320 + _output_s0_x;
    ((uint8_t *)_output)[_321] = _318;
   } // for _output_s0_x
  } // for _output_s0_y
