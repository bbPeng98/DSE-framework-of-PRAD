...
static RDAI_Device aha_halide_hardware_resnet_pond_layer_1 = {
	{ 1 },
	{
		{ "aha" },
		{ "halide_hardware"  },
...
static RDAI_Device *rdai_clockwork_platform_devices[2] = { &aha_halide_hardware_resnet_pond_layer_1, NULL };
