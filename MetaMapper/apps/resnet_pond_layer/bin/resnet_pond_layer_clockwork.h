#ifndef HALIDE_____bin___resnet_pond_layer_clockwork_h
#define HALIDE_____bin___resnet_pond_layer_clockwork_h
#include <stdint.h>
...
int resnet_pond_layer_clockwork_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *resnet_pond_layer_clockwork_metadata() HALIDE_FUNCTION_ATTRS;
