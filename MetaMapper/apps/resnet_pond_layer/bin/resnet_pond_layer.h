#ifndef HALIDE_____bin___resnet_pond_layer_h
#define HALIDE_____bin___resnet_pond_layer_h
#include <stdint.h>
...
int resnet_pond_layer(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_kernel_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int resnet_pond_layer_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *resnet_pond_layer_metadata() HALIDE_FUNCTION_ATTRS;
