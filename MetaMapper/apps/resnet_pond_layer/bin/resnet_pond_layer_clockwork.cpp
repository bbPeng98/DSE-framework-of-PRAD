...
int resnet_pond_layer_clockwork(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_kernel_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
 ...
 if (_38)
 {
  ...
  if (!_74)   {
   ...
   int32_t _77 = _76 + _75;
   int32_t _78 = _77 + -1;
   int32_t _79 = halide_error_access_out_of_bounds(_ucon, "Input buffer input", 0, 0, 7, _75, _78);
   return _79;
  }
  ...
  if (!_119)   {
   ...
   int32_t _123 = _122 + -1;
   int32_t _124 = halide_error_access_out_of_bounds(_ucon, "Input buffer kernel", 0, 0, 7, _120, _123);
   return _124;
  }
  ...
  RDAI_MemObject *_hw_input_stencil = RDAI_mem_shared_allocate(14400);
  // produce hw_input.stencil
  for (int _hw_input_s0_y = 0; _hw_input_s0_y < 0 + 30; _hw_input_s0_y++)
  {
   int32_t _616 = ::halide_cpp_min(_hw_input_s0_y, 28);
   int32_t _617 = ::halide_cpp_max(_616, 1);
   for (int _hw_input_s0_x = 0; _hw_input_s0_x < 0 + 30; _hw_input_s0_x++)
   {
    int32_t _618 = ::halide_cpp_min(_hw_input_s0_x, 28);
    int32_t _619 = ::halide_cpp_max(_618, 1);
    for (int _hw_input_s0_z = 0; _hw_input_s0_z < 0 + 8; _hw_input_s0_z++)
    {
     // Provision buffer _hw_input_stencil
     int32_t _620 = _halide_buffer_get_stride(_input_buffer, 1);
     int32_t _621 = _620 * _619;
     int32_t _622 = _halide_buffer_get_stride(_input_buffer, 2);
     int32_t _623 = _622 * _617;
     int32_t _624 = _620 * -1;
     int32_t _625 = _halide_buffer_get_min(_input_buffer, 1);
     int32_t _626 = _625 * _620;
     int32_t _627 = _halide_buffer_get_min(_input_buffer, 0);
     int32_t _628 = _halide_buffer_get_min(_input_buffer, 2);
     int32_t _629 = _628 * _622;
     int32_t _630 = _627 + _629;
     int32_t _631 = _626 + _630;
     int32_t _632 = _624 - _631;
     int32_t _633 = _632 - _622;
     int32_t _634 = _623 + _633;
     int32_t _635 = _621 + _634;
     int32_t _636 = _635 + _hw_input_s0_z;
     int16_t _637 = ((const int16_t *)_input)[_636];
_637;
     int16_t *_hw_input_stencil_host = (int16_t *) _hw_input_stencil->host_ptr;
     int32_t _638 = _hw_input_s0_y * 240;
     int32_t _639 = _hw_input_s0_x * 8;
     int32_t _640 = _639 + _hw_input_s0_z;
     int32_t _641 = _638 + _640;
_641;
     _hw_input_stencil_host[_641] = _637;
    } // for _hw_input_s0_z
   } // for _hw_input_s0_x
  } // for _hw_input_s0_y
  // consume hw_input.stencil
  // Allocate shared buffer for _hw_kernel_stencil
  RDAI_MemObject *_hw_kernel_stencil = RDAI_mem_shared_allocate(432);
  ...
  for (int _hw_kernel_s0_y = 0; _hw_kernel_s0_y < 0 + 3; _hw_kernel_s0_y++)
  {
   for (int _hw_kernel_s0_x = 0; _hw_kernel_s0_x < 0 + 3; _hw_kernel_s0_x++)
   {
    ...
    {
     for (int _hw_kernel_s0_z = 0; _hw_kernel_s0_z < 0 + 8; _hw_kernel_s0_z++)
     {
      // Provision buffer _hw_kernel_stencil
      int32_t _642 = _halide_buffer_get_stride(_kernel_buffer, 1);
      int32_t _643 = _642 * _hw_kernel_s0_w;
      int32_t _644 = _halide_buffer_get_stride(_kernel_buffer, 2);
      int32_t _645 = _644 * _hw_kernel_s0_x;
      int32_t _646 = _halide_buffer_get_stride(_kernel_buffer, 3);
      int32_t _647 = _646 * _hw_kernel_s0_y;
      int32_t _648 = _halide_buffer_get_min(_kernel_buffer, 1);
      int32_t _649 = _648 * _642;
      int32_t _650 = _halide_buffer_get_min(_kernel_buffer, 0);
      int32_t _651 = _halide_buffer_get_min(_kernel_buffer, 3);
      int32_t _652 = _651 * _646;
      int32_t _653 = _halide_buffer_get_min(_kernel_buffer, 2);
      int32_t _654 = _653 * _644;
      int32_t _655 = _652 + _654;
      int32_t _656 = _650 + _655;
      int32_t _657 = _649 + _656;
      int32_t _658 = _647 - _657;
      int32_t _659 = _645 + _658;
      int32_t _660 = _643 + _659;
      int32_t _661 = _660 + _hw_kernel_s0_z;
      int16_t _662 = ((const int16_t *)_kernel)[_661];
_662;
      int16_t *_hw_kernel_stencil_host = (int16_t *) _hw_kernel_stencil->host_ptr;
      int32_t _663 = _hw_kernel_s0_y * 72;
      int32_t _664 = _hw_kernel_s0_x * 24;
      int32_t _665 = _hw_kernel_s0_w * 8;
      int32_t _666 = _665 + _hw_kernel_s0_z;
      int32_t _667 = _664 + _666;
      int32_t _668 = _663 + _667;
_668;
      _hw_kernel_stencil_host[_668] = _662;
     } // for _hw_kernel_s0_z
    } // for _hw_kernel_s0_w
   } // for _hw_kernel_s0_x
  } // for _hw_kernel_s0_y
  ...
  RDAI_VLNV device_vlnv = {{"aha"}, {"halide_hardware"}, {"resnet_pond_layer"}, 1};
  ...
  int32_t _888 = _halide_buffer_get_min(_output_buffer, 2);
  bool _889 = 0 <= _888;
  int32_t _890 = _halide_buffer_get_extent(_output_buffer, 2);
  int32_t _891 = _890 + _888;
  bool _892 = _891 <= 3;
  bool _893 = _889 && _892;
  if (!_893)   {
   int32_t _894 = _halide_buffer_get_min(_output_buffer, 2);
   int32_t _895 = _halide_buffer_get_extent(_output_buffer, 2);
   int32_t _896 = _895 + _894;
   int32_t _897 = _896 + -1;
   int32_t _898 = halide_error_explicit_bounds_too_small(_ucon, "w", "output", 0, 2, _894, _897);
   return _898;
  }
  int32_t _899 = _halide_buffer_get_min(_output_buffer, 1);
  bool _900 = 0 <= _899;
  int32_t _901 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _902 = _901 + _899;
  bool _903 = _902 <= 28;
  bool _904 = _900 && _903;
  if (!_904)   {
   int32_t _905 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _906 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _907 = _906 + _905;
   int32_t _908 = _907 + -1;
   int32_t _909 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 27, _905, _908);
   return _909;
  }
  int32_t _910 = _halide_buffer_get_min(_output_buffer, 0);
  bool _911 = 0 <= _910;
  int32_t _912 = _halide_buffer_get_extent(_output_buffer, 0);
  int32_t _913 = _912 + _910;
  bool _914 = _913 <= 28;
  bool _915 = _911 && _914;
  if (!_915)   {
   int32_t _916 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _917 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _918 = _917 + _916;
   int32_t _919 = _918 + -1;
   int32_t _920 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 27, _916, _919);
   return _920;
  }
  // produce output
  for (int _output_s0_w = 0; _output_s0_w < 0 + 3; _output_s0_w++)
  {
   for (int _output_s0_y = 0; _output_s0_y < 0 + 28; _output_s0_y++)
   {
    ...
    {
     int32_t _921 = _output_s0_w * 784;
     int32_t _922 = _output_s0_y * 28;
     int32_t _923 = _922 + _output_s0_x;
     int32_t _924 = _921 + _923;
_924;
     int16_t *_hw_output_stencil_host = (int16_t *) _hw_output_stencil->host_ptr;
     int16_t _925 = _hw_output_stencil_host[_924];
     int32_t _926 = _halide_buffer_get_stride(_output_buffer, 2);
     int32_t _927 = _926 * _output_s0_w;
     int32_t _928 = _halide_buffer_get_stride(_output_buffer, 1);
     int32_t _929 = _928 * _output_s0_y;
     int32_t _930 = _927 + _929;
     int32_t _931 = _930 + _output_s0_x;
     ((int16_t *)_output)[_931] = _925;
    } // for _output_s0_x
   } // for _output_s0_y
  } // for _output_s0_w
