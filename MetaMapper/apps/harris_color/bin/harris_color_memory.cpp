...
////producing gray.stencil
  ...
  auto gray_s0_x_x = gray_s0_y->add_loop("gray_s0_x_x", 0, 64);
...
////producing grad_x_unclamp.stencil
  ...
  auto grad_x_unclamp_s0_x_x = grad_x_unclamp_s0_y->add_loop("grad_x_unclamp_s0_x_x", 0, 63);
...
//store is: grad_x_unclamp.stencil(((grad_x_unclamp_s0_x_x*2) + 1), grad_x_unclamp_s0_y) = (int16)0
  ...
  auto grad_x_unclamp_s1_x_x = grad_x_unclamp_s1_y->add_loop("grad_x_unclamp_s1_x_x", 0, 63);
...
////producing lxx.stencil
  ...
  auto lxx_s0_x_x = lxx_s0_y->add_loop("lxx_s0_x_x", 0, 63);
...
////producing lgxx.stencil
  ...
  auto lgxx_s0_x_x = lgxx_s0_y->add_loop("lgxx_s0_x_x", 0, 62);
...
//store is: lgxx.stencil(((lgxx_s0_x_x*2) + 1), lgxx_s0_y) = (int16)0
  ...
  auto lgxx_s1_x_x = lgxx_s1_y->add_loop("lgxx_s1_x_x", 0, 62);
...
////producing grad_y_unclamp.stencil
  ...
  auto grad_y_unclamp_s0_x_x = grad_y_unclamp_s0_y->add_loop("grad_y_unclamp_s0_x_x", 0, 63);
...
//store is: grad_y_unclamp.stencil(((grad_y_unclamp_s0_x_x*2) + 1), grad_y_unclamp_s0_y) = (int16)0
  ...
  auto grad_y_unclamp_s1_x_x = grad_y_unclamp_s1_y->add_loop("grad_y_unclamp_s1_x_x", 0, 63);
...
////producing lxy.stencil
  ...
  auto lxy_s0_x_x = lxy_s0_y->add_loop("lxy_s0_x_x", 0, 63);
...
////producing lgxy.stencil
  ...
  auto lgxy_s0_x_x = lgxy_s0_y->add_loop("lgxy_s0_x_x", 0, 62);
...
//store is: lgxy.stencil(((lgxy_s0_x_x*2) + 1), lgxy_s0_y) = (int16)0
  ...
  auto lgxy_s1_x_x = lgxy_s1_y->add_loop("lgxy_s1_x_x", 0, 62);
...
////producing lyy.stencil
  ...
  auto lyy_s0_x_x = lyy_s0_y->add_loop("lyy_s0_x_x", 0, 63);
...
////producing lgyy.stencil
  ...
  auto lgyy_s0_x_x = lgyy_s0_y->add_loop("lgyy_s0_x_x", 0, 62);
...
//store is: lgyy.stencil(((lgyy_s0_x_x*2) + 1), lgyy_s0_y) = (int16)0
  ...
  auto lgyy_s1_x_x = lgyy_s1_y->add_loop("lgyy_s1_x_x", 0, 62);
...
////producing cim.stencil
  ...
  auto cim_s0_x_x = cim_s0_y->add_loop("cim_s0_x_x", 0, 62);
...
//consuming cim.stencil
  ...
  auto hw_output_s0_x_xi_xi = hw_output_s0_y_yi->add_loop("hw_output_s0_x_xi_xi", 0, 61);
...
//consuming hw_output.glb.stencil
  ...
  auto hw_output_global_wrapper_s0_x_xi_xi = hw_output_global_wrapper_s0_y_yi->add_loop("hw_output_global_wrapper_s0_x_xi_xi", 0, 61);
