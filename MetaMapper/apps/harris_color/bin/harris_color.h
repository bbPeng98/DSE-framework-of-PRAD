#ifndef HALIDE_____bin___harris_color_h
#define HALIDE_____bin___harris_color_h
#include <stdint.h>
...
int harris_color(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int harris_color_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *harris_color_metadata() HALIDE_FUNCTION_ATTRS;
