#ifndef HALIDE_____bin___harris_color_clockwork_h
#define HALIDE_____bin___harris_color_clockwork_h
#include <stdint.h>
...
int harris_color_clockwork_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *harris_color_clockwork_metadata() HALIDE_FUNCTION_ATTRS;
