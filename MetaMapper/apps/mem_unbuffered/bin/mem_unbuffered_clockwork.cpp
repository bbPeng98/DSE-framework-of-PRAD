...
int mem_unbuffered_clockwork(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
...
_255;
  ...
  RDAI_VLNV device_vlnv = {{"aha"}, {"halide_hardware"}, {"mem_unbuffered"}, 1};
  ...
  int32_t _356 = _halide_buffer_get_min(_output_buffer, 1);
  bool _357 = 0 <= _356;
  int32_t _358 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _359 = _358 + _356;
  bool _360 = _359 <= 62;
  bool _361 = _357 && _360;
  if (!_361)   {
   int32_t _362 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _363 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _364 = _363 + _362;
   int32_t _365 = _364 + -1;
   int32_t _366 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 61, _362, _365);
   return _366;
  }
  int32_t _367 = _halide_buffer_get_min(_output_buffer, 0);
  bool _368 = 0 <= _367;
  int32_t _369 = _halide_buffer_get_extent(_output_buffer, 0);
  int32_t _370 = _369 + _367;
  bool _371 = _370 <= 62;
  bool _372 = _368 && _371;
  if (!_372)   {
   int32_t _373 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _374 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _375 = _374 + _373;
   int32_t _376 = _375 + -1;
   int32_t _377 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 61, _373, _376);
   return _377;
  }
  // produce output
  for (int _output_s0_y = 0; _output_s0_y < 0 + 62; _output_s0_y++)
  {
   ...
   {
    int32_t _378 = _output_s0_y * 62;
    int32_t _379 = _378 + _output_s0_x;
_379;
    uint16_t *_hw_output_stencil_host = (uint16_t *) _hw_output_stencil->host_ptr;
    uint16_t _380 = _hw_output_stencil_host[_379];
    uint8_t _381 = (uint8_t)(_380);
    int32_t _382 = _halide_buffer_get_stride(_output_buffer, 1);
    int32_t _383 = _382 * _output_s0_y;
    int32_t _384 = _383 + _output_s0_x;
    ((uint8_t *)_output)[_384] = _381;
   } // for _output_s0_x
  } // for _output_s0_y
