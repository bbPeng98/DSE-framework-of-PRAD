#ifndef HALIDE_____bin___mem_unbuffered_h
#define HALIDE_____bin___mem_unbuffered_h
#include <stdint.h>
...
int mem_unbuffered(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int mem_unbuffered_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *mem_unbuffered_metadata() HALIDE_FUNCTION_ATTRS;
