#ifndef HALIDE_____bin___conv_2input_h
#define HALIDE_____bin___conv_2input_h
#include <stdint.h>
...
int conv_2input(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_weight_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int conv_2input_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *conv_2input_metadata() HALIDE_FUNCTION_ATTRS;
