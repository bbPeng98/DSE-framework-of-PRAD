...
int unsharp_clockwork(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
 ...
 if (_25)
 {
  ...
  if (!_96)   {
   ...
   int32_t _99 = _98 + _97;
   int32_t _100 = _99 + -1;
   int32_t _101 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 0, 0, 57, _97, _100);
   return _101;
  }
  ...
  if (!_111)   {
   ...
   int32_t _115 = _114 + -1;
   int32_t _116 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 1, 0, 57, _112, _115);
   return _116;
  }
  ...
  if (!_126)   {
   ...
   int32_t _130 = _129 + -1;
   int32_t _131 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 2, 0, 2, _127, _130);
   return _131;
  }
  ...
  RDAI_MemObject *_hw_input_stencil = RDAI_mem_shared_allocate(24576);
  // produce hw_input.stencil
  for (int _hw_input_s0_y = -3; _hw_input_s0_y < -3 + 64; _hw_input_s0_y++)
  {
   for (int _hw_input_s0_x = -3; _hw_input_s0_x < -3 + 64; _hw_input_s0_x++)
   {
    for (int _hw_input_s0_c = 0; _hw_input_s0_c < 0 + 3; _hw_input_s0_c++)
    {
     // Provision buffer _hw_input_stencil
     int32_t _366 = _halide_buffer_get_stride(_input_buffer, 2);
     int32_t _367 = _366 * _hw_input_s0_c;
     int32_t _368 = _halide_buffer_get_stride(_input_buffer, 1);
     int32_t _369 = _368 * _hw_input_s0_y;
     int32_t _370 = _368 * 3;
     int32_t _371 = _halide_buffer_get_min(_input_buffer, 2);
     int32_t _372 = _371 * _366;
     int32_t _373 = _370 - _372;
     int32_t _374 = _halide_buffer_get_min(_input_buffer, 0);
     int32_t _375 = _373 - _374;
     int32_t _376 = _halide_buffer_get_min(_input_buffer, 1);
     int32_t _377 = _376 * _368;
     int32_t _378 = _375 - _377;
     int32_t _379 = _369 + _378;
     int32_t _380 = _379 + _hw_input_s0_x;
     int32_t _381 = _367 + _380;
     int32_t _382 = _381 + 3;
     uint8_t _383 = ((const uint8_t *)_input)[_382];
     uint16_t _384 = (uint16_t)(_383);
_384;
     uint16_t *_hw_input_stencil_host = (uint16_t *) _hw_input_stencil->host_ptr;
     int32_t _385 = _hw_input_s0_y * 192;
     int32_t _386 = _hw_input_s0_x * 3;
     int32_t _387 = _386 + _hw_input_s0_c;
     int32_t _388 = _385 + _387;
     int32_t _389 = _388 + 585;
_389;
     _hw_input_stencil_host[_389] = _384;
    } // for _hw_input_s0_c
   } // for _hw_input_s0_x
  } // for _hw_input_s0_y
  // consume hw_input.stencil
  // Allocate shared buffer for _hw_output_stencil
  RDAI_MemObject *_hw_output_stencil = RDAI_mem_shared_allocate(20184);
  ...
  RDAI_VLNV device_vlnv = {{"aha"}, {"halide_hardware"}, {"unsharp"}, 1};
  ...
  int32_t _1389 = _halide_buffer_get_min(_output_buffer, 1);
  bool _1390 = 0 <= _1389;
  int32_t _1391 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _1392 = _1391 + _1389;
  bool _1393 = _1392 <= 58;
  bool _1394 = _1390 && _1393;
  if (!_1394)   {
   int32_t _1395 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _1396 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _1397 = _1396 + _1395;
   int32_t _1398 = _1397 + -1;
   int32_t _1399 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 57, _1395, _1398);
   return _1399;
  }
  int32_t _1400 = _halide_buffer_get_min(_output_buffer, 0);
  bool _1401 = 0 <= _1400;
  int32_t _1402 = _halide_buffer_get_extent(_output_buffer, 0);
  int32_t _1403 = _1402 + _1400;
  bool _1404 = _1403 <= 58;
  bool _1405 = _1401 && _1404;
  if (!_1405)   {
   int32_t _1406 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _1407 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _1408 = _1407 + _1406;
   int32_t _1409 = _1408 + -1;
   int32_t _1410 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 57, _1406, _1409);
   return _1410;
  }
  int32_t _1411 = _halide_buffer_get_min(_output_buffer, 2);
  bool _1412 = 0 <= _1411;
  int32_t _1413 = _halide_buffer_get_extent(_output_buffer, 2);
  int32_t _1414 = _1413 + _1411;
  bool _1415 = _1414 <= 3;
  bool _1416 = _1412 && _1415;
  if (!_1416)   {
   int32_t _1417 = _halide_buffer_get_min(_output_buffer, 2);
   int32_t _1418 = _halide_buffer_get_extent(_output_buffer, 2);
   int32_t _1419 = _1418 + _1417;
   int32_t _1420 = _1419 + -1;
   int32_t _1421 = halide_error_explicit_bounds_too_small(_ucon, "c", "output", 0, 2, _1417, _1420);
   return _1421;
  }
  // produce output
  for (int _output_s0_c = 0; _output_s0_c < 0 + 3; _output_s0_c++)
  {
   for (int _output_s0_y = 0; _output_s0_y < 0 + 58; _output_s0_y++)
   {
    ...
    {
     int32_t _1422 = _output_s0_y * 174;
     int32_t _1423 = _output_s0_x * 3;
     int32_t _1424 = _1423 + _output_s0_c;
     int32_t _1425 = _1422 + _1424;
_1425;
     int16_t *_hw_output_stencil_host = (int16_t *) _hw_output_stencil->host_ptr;
     int16_t _1426 = _hw_output_stencil_host[_1425];
     uint8_t _1427 = (uint8_t)(_1426);
     int32_t _1428 = _halide_buffer_get_stride(_output_buffer, 2);
     int32_t _1429 = _1428 * _output_s0_c;
     int32_t _1430 = _halide_buffer_get_stride(_output_buffer, 1);
     int32_t _1431 = _1430 * _output_s0_y;
     int32_t _1432 = _1429 + _1431;
     int32_t _1433 = _1432 + _output_s0_x;
     ((uint8_t *)_output)[_1433] = _1427;
    } // for _output_s0_x
   } // for _output_s0_y
  } // for _output_s0_c
