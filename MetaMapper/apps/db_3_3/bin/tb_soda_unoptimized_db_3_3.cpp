// AUTO GEN SODA TB
#include "unoptimized_db_3_3_kernel.h"
#include <iostream>
#include <fstream>
...
int main() {
  ...
  unoptimized_db_3_3_kernel(hw_output_stencil, hw_input_stencil, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_unoptimized_db_3_3_regression_result.csv", hw_output_stencil, nrows, ncols, transfer_cols);
