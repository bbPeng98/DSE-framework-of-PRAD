...
int conv_5_5_clockwork(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
 ...
 if (_25)
 {
  ...
  if (!_81)   {
   ...
   int32_t _84 = _83 + _82;
   int32_t _85 = _84 + -1;
   int32_t _86 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 0, 0, 59, _82, _85);
   return _86;
  }
  ...
  if (!_96)   {
   ...
   int32_t _99 = _98 + _97;
   int32_t _100 = _99 + -1;
   int32_t _101 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 1, 0, 59, _97, _100);
   return _101;
  }
...
_255;
  ...
  RDAI_MemObject *_hw_output_stencil = RDAI_mem_shared_allocate(7200);
  ...
  RDAI_VLNV device_vlnv = {{"aha"}, {"halide_hardware"}, {"conv_5_5"}, 1};
  ...
  int32_t _504 = _halide_buffer_get_min(_output_buffer, 1);
  bool _505 = 0 <= _504;
  int32_t _506 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _507 = _506 + _504;
  bool _508 = _507 <= 60;
  bool _509 = _505 && _508;
  if (!_509)   {
   int32_t _510 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _511 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _512 = _511 + _510;
   int32_t _513 = _512 + -1;
   int32_t _514 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 59, _510, _513);
   return _514;
  }
  int32_t _515 = _halide_buffer_get_min(_output_buffer, 0);
  bool _516 = 0 <= _515;
  int32_t _517 = _halide_buffer_get_extent(_output_buffer, 0);
  int32_t _518 = _517 + _515;
  bool _519 = _518 <= 60;
  bool _520 = _516 && _519;
  if (!_520)   {
   int32_t _521 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _522 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _523 = _522 + _521;
   int32_t _524 = _523 + -1;
   int32_t _525 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 59, _521, _524);
   return _525;
  }
  // produce output
  for (int _output_s0_y = 0; _output_s0_y < 0 + 60; _output_s0_y++)
  {
   for (int _output_s0_x = 0; _output_s0_x < 0 + 60; _output_s0_x++)
   {
    int32_t _526 = _output_s0_y * 60;
    int32_t _527 = _526 + _output_s0_x;
_527;
    uint16_t *_hw_output_stencil_host = (uint16_t *) _hw_output_stencil->host_ptr;
    uint16_t _528 = _hw_output_stencil_host[_527];
    uint8_t _529 = (uint8_t)(_528);
    int32_t _530 = _halide_buffer_get_stride(_output_buffer, 1);
    int32_t _531 = _530 * _output_s0_y;
    int32_t _532 = _531 + _output_s0_x;
    ((uint8_t *)_output)[_532] = _529;
   } // for _output_s0_x
  } // for _output_s0_y
