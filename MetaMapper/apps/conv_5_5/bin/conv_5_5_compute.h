...
hw_uint<16> hcompute_conv_stencil_1(hw_uint<16>& conv_stencil, hw_uint<384>& hw_input_global_wrapper_stencil) {
  ...
  uint16_t _hw_input_global_wrapper_stencil_3 = (uint16_t) (hw_input_global_wrapper_stencil.extract<272, 287>());
  uint16_t _hw_input_global_wrapper_stencil_4 = (uint16_t) (hw_input_global_wrapper_stencil.extract<288, 303>());
  uint16_t _hw_input_global_wrapper_stencil_5 = (uint16_t) (hw_input_global_wrapper_stencil.extract<304, 319>());
  uint16_t _hw_input_global_wrapper_stencil_6 = (uint16_t) (hw_input_global_wrapper_stencil.extract<320, 335>());
  uint16_t _hw_input_global_wrapper_stencil_7 = (uint16_t) (hw_input_global_wrapper_stencil.extract<336, 351>());
  uint16_t _hw_input_global_wrapper_stencil_8 = (uint16_t) (hw_input_global_wrapper_stencil.extract<352, 367>());
  uint16_t _hw_input_global_wrapper_stencil_9 = (uint16_t) (hw_input_global_wrapper_stencil.extract<368, 383>());
  ...
  uint16_t _270 = (uint16_t)(12);
  uint16_t _271 = _hw_input_global_wrapper_stencil_6 * _270;
  uint16_t _272 = (uint16_t)(18);
  uint16_t _273 = _hw_input_global_wrapper_stencil_7 * _272;
  uint16_t _274 = (uint16_t)(29);
  uint16_t _275 = _hw_input_global_wrapper_stencil_8 * _274;
  uint16_t _276 = (uint16_t)(39);
  uint16_t _277 = _hw_input_global_wrapper_stencil_9 * _276;
  uint16_t _278 = (uint16_t)(13);
  uint16_t _279 = _hw_input_global_wrapper_stencil_10 * _278;
  uint16_t _280 = (uint16_t)(16);
  uint16_t _281 = _hw_input_global_wrapper_stencil_11 * _280;
  uint16_t _282 = (uint16_t)(19);
  uint16_t _283 = _hw_input_global_wrapper_stencil_12 * _282;
  uint16_t _284 = (uint16_t)(22);
  uint16_t _285 = _hw_input_global_wrapper_stencil_13 * _284;
  uint16_t _286 = (uint16_t)(32);
  uint16_t _287 = _hw_input_global_wrapper_stencil_14 * _286;
  uint16_t _288 = (uint16_t)(23);
  uint16_t _289 = _hw_input_global_wrapper_stencil_15 * _288;
  uint16_t _290 = (uint16_t)(21);
  uint16_t _291 = _hw_input_global_wrapper_stencil_16 * _290;
  uint16_t _292 = (uint16_t)(26);
  uint16_t _293 = _hw_input_global_wrapper_stencil_17 * _292;
  uint16_t _294 = (uint16_t)(24);
  uint16_t _295 = _hw_input_global_wrapper_stencil_18 * _294;
  uint16_t _296 = (uint16_t)(34);
  uint16_t _297 = _hw_input_global_wrapper_stencil_19 * _296;
  uint16_t _298 = (uint16_t)(33);
  uint16_t _299 = _hw_input_global_wrapper_stencil_20 * _298;
  uint16_t _300 = (uint16_t)(31);
  uint16_t _301 = _hw_input_global_wrapper_stencil_21 * _300;
  uint16_t _302 = _hw_input_global_wrapper_stencil_22 * _286;
  uint16_t _303 = (uint16_t)(37);
  uint16_t _304 = _hw_input_global_wrapper_stencil_23 * _303;
  uint16_t _305 = _hw_input_global_wrapper_stencil_24 * _296;
  uint16_t _306 = _304 + _305;
  uint16_t _307 = _302 + _306;
  uint16_t _308 = _301 + _307;
  uint16_t _309 = _299 + _308;
  uint16_t _310 = _297 + _309;
  uint16_t _311 = _295 + _310;
  uint16_t _312 = _293 + _311;
  uint16_t _313 = _291 + _312;
  uint16_t _314 = _289 + _313;
  uint16_t _315 = _287 + _314;
  uint16_t _316 = _285 + _315;
  uint16_t _317 = _283 + _316;
  uint16_t _318 = _281 + _317;
  uint16_t _319 = _279 + _318;
  uint16_t _320 = _277 + _319;
  uint16_t _321 = _275 + _320;
  uint16_t _322 = _273 + _321;
  uint16_t _323 = _271 + _322;
  uint16_t _324 = _269 + _323;
  uint16_t _325 = _267 + _324;
  uint16_t _326 = _265 + _325;
  uint16_t _327 = _263 + _326;
  uint16_t _328 = _conv_stencil_1 + _327;
  uint16_t _329 = _261 + _328;
  return _329;
}
