...
////producing b_b.stencil
  auto b_b_s0_y = prg.add_loop("b_b_s0_y", -1, 92);
...
////producing g_gb.stencil
  auto g_gb_s0_y = prg.add_loop("g_gb_s0_y", -1, 93);
  auto g_gb_s0_x = g_gb_s0_y->add_loop("g_gb_s0_x", -1, 125);
...
////producing g_gr.stencil
  auto g_gr_s0_y = prg.add_loop("g_gr_s0_y", -1, 93);
  auto g_gr_s0_x = g_gr_s0_y->add_loop("g_gr_s0_x", -1, 125);
...
////producing g_b.stencil
  auto g_b_s0_y = prg.add_loop("g_b_s0_y", -1, 92);
...
////producing g_r.stencil
  ...
  auto g_r_s0_x = g_r_s0_y->add_loop("g_r_s0_x", -1, 124);
...
////producing r_r.stencil
  ...
  auto r_r_s0_x = r_r_s0_y->add_loop("r_r_s0_x", -1, 124);
