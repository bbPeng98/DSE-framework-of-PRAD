#ifndef HALIDE_____bin___resnet_clockwork_h
#define HALIDE_____bin___resnet_clockwork_h
#include <stdint.h>
...
int resnet_clockwork_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *resnet_clockwork_metadata() HALIDE_FUNCTION_ATTRS;
