#ifndef HALIDE_____bin___scomp_h
#define HALIDE_____bin___scomp_h
#include <stdint.h>
...
int scomp(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int scomp_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *scomp_metadata() HALIDE_FUNCTION_ATTRS;
