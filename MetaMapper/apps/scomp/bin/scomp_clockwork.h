#ifndef HALIDE_____bin___scomp_clockwork_h
#define HALIDE_____bin___scomp_clockwork_h
#include <stdint.h>
...
int scomp_clockwork_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *scomp_clockwork_metadata() HALIDE_FUNCTION_ATTRS;
