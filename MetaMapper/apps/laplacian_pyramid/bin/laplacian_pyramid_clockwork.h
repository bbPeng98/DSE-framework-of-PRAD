#ifndef HALIDE_____bin___laplacian_pyramid_clockwork_h
#define HALIDE_____bin___laplacian_pyramid_clockwork_h
#include <stdint.h>
...
int laplacian_pyramid_clockwork_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *laplacian_pyramid_clockwork_metadata() HALIDE_FUNCTION_ATTRS;
