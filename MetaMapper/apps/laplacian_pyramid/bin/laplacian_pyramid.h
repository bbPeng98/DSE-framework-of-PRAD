#ifndef HALIDE_____bin___laplacian_pyramid_h
#define HALIDE_____bin___laplacian_pyramid_h
#include <stdint.h>
...
int laplacian_pyramid(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int laplacian_pyramid_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *laplacian_pyramid_metadata() HALIDE_FUNCTION_ATTRS;
