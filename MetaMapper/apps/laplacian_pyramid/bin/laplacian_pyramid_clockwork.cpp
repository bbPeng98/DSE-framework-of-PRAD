...
int laplacian_pyramid_clockwork(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
 ...
 if (_9)
 {
  ...
  int32_t _12 = _10 + _11;
  int32_t _13 = ::halide_cpp_min(_12, -6);
  int32_t _14 = _13 + -1;
  int32_t _15 = ::halide_cpp_max(_11, _14);
  int32_t _16 = ::halide_cpp_min(_12, 68);
  int32_t _17 = _11 + 1;
  ...
  int32_t _21 = _19 + _20;
  int32_t _22 = ::halide_cpp_min(_21, -6);
  int32_t _23 = _22 + -1;
  int32_t _24 = ::halide_cpp_max(_20, _23);
  struct halide_dimension_t *_25 = _halide_buffer_get_shape(_input_buffer);
  uint64_t _26 = (uint64_t)(0);
  void *_27 = (void *)(_26);
  struct halide_device_interface_t *_28 = (struct halide_device_interface_t *)(_26);
  int32_t _29 = _18 - _15;
  int32_t _30 = ::halide_cpp_min(_21, 68);
  int32_t _31 = _20 + 1;
  int32_t _32 = ::halide_cpp_max(_30, _31);
  int32_t _33 = _32 - _24;
  struct {
   const int32_t f_0;
   const int32_t f_1;
  ...
  struct halide_dimension_t *_34 = (struct halide_dimension_t *)(&s0);
  struct halide_buffer_t *_35 = _halide_buffer_init(_input_buffer, _25, _27, _26, _28, 1, 8, 2, _34, _26);
  (void)_35;
 } // if _9
 bool _36 = _halide_buffer_is_bounds_query(_output_buffer);
 if (_36)
 {
  struct halide_dimension_t *_37 = _halide_buffer_get_shape(_output_buffer);
  uint64_t _38 = (uint64_t)(0);
  void *_39 = (void *)(_38);
  struct halide_device_interface_t *_40 = (struct halide_device_interface_t *)(_38);
  struct {
   const int32_t f_0;
   const int32_t f_1;
   const int32_t f_2;
  ...
  struct halide_dimension_t *_41 = (struct halide_dimension_t *)(&s1);
  struct halide_buffer_t *_42 = _halide_buffer_init(_output_buffer, _37, _39, _38, _40, 1, 8, 2, _41, _38);
  (void)_42;
 } // if _36
 bool _43 = _halide_buffer_is_bounds_query(_input_buffer);
 bool _44 = _halide_buffer_is_bounds_query(_output_buffer);
 bool _45 = _43 || _44;
 bool _46 = !(_45);
 if (_46)
 {
  uint32_t _47 = _halide_buffer_get_type(_input_buffer);
  uint32_t _48 = (uint32_t)(67585);
  bool _49 = _47 == _48;
  if (!_49)   {
   uint32_t _50 = _halide_buffer_get_type(_input_buffer);
   uint32_t _51 = (uint32_t)(67585);
   int32_t _52 = halide_error_bad_type(_ucon, "Input buffer input", _50, _51);
   return _52;
  }
  int32_t _53 = _halide_buffer_get_dimensions(_input_buffer);
  bool _54 = _53 == 2;
  if (!_54)   {
   int32_t _55 = _halide_buffer_get_dimensions(_input_buffer);
   int32_t _56 = halide_error_bad_dimensions(_ucon, "Input buffer input", _55, 2);
   return _56;
  }
  uint32_t _57 = _halide_buffer_get_type(_output_buffer);
  uint32_t _58 = (uint32_t)(67585);
  bool _59 = _57 == _58;
  if (!_59)   {
   uint32_t _60 = _halide_buffer_get_type(_output_buffer);
   uint32_t _61 = (uint32_t)(67585);
   int32_t _62 = halide_error_bad_type(_ucon, "Output buffer output", _60, _61);
   return _62;
  }
  int32_t _63 = _halide_buffer_get_dimensions(_output_buffer);
  bool _64 = _63 == 2;
  if (!_64)   {
   int32_t _65 = _halide_buffer_get_dimensions(_output_buffer);
   int32_t _66 = halide_error_bad_dimensions(_ucon, "Output buffer output", _65, 2);
   return _66;
  }
  int32_t _67 = _halide_buffer_get_extent(_input_buffer, 0);
  int32_t _68 = _halide_buffer_get_min(_input_buffer, 0);
  int32_t _69 = _67 + _68;
  int32_t _70 = ::halide_cpp_min(_69, 68);
  int32_t _71 = _68 + 1;
  int32_t _72 = ::halide_cpp_max(_70, _71);
  bool _73 = _72 <= _69;
  if (!_73)   {
   int32_t _74 = _halide_buffer_get_extent(_input_buffer, 0);
   int32_t _75 = _halide_buffer_get_min(_input_buffer, 0);
   int32_t _76 = _74 + _75;
   int32_t _77 = ::halide_cpp_min(_76, -6);
   int32_t _78 = _77 + -1;
   int32_t _79 = ::halide_cpp_max(_75, _78);
   int32_t _80 = ::halide_cpp_min(_76, 68);
   int32_t _81 = _80 + -1;
   int32_t _82 = ::halide_cpp_max(_75, _81);
   int32_t _83 = _76 + -1;
   int32_t _84 = halide_error_access_out_of_bounds(_ucon, "Input buffer input", 0, _79, _82, _75, _83);
   return _84;
  }
  int32_t _85 = _halide_buffer_get_extent(_input_buffer, 0);
  bool _86 = 0 <= _85;
  if (!_86)   {
   int32_t _87 = _halide_buffer_get_extent(_input_buffer, 0);
   int32_t _88 = halide_error_buffer_extents_negative(_ucon, "Input buffer input", 0, _87);
   return _88;
  }
  int32_t _89 = _halide_buffer_get_extent(_input_buffer, 1);
  int32_t _90 = _halide_buffer_get_min(_input_buffer, 1);
  int32_t _91 = _89 + _90;
  int32_t _92 = ::halide_cpp_min(_91, 68);
  int32_t _93 = _90 + 1;
  int32_t _94 = ::halide_cpp_max(_92, _93);
  bool _95 = _94 <= _91;
  if (!_95)   {
   int32_t _96 = _halide_buffer_get_extent(_input_buffer, 1);
   int32_t _97 = _halide_buffer_get_min(_input_buffer, 1);
   int32_t _98 = _96 + _97;
   int32_t _99 = ::halide_cpp_min(_98, -6);
   int32_t _100 = _99 + -1;
   int32_t _101 = ::halide_cpp_max(_97, _100);
   int32_t _102 = ::halide_cpp_min(_98, 68);
   int32_t _103 = _102 + -1;
   int32_t _104 = ::halide_cpp_max(_97, _103);
   int32_t _105 = _98 + -1;
   int32_t _106 = halide_error_access_out_of_bounds(_ucon, "Input buffer input", 1, _101, _104, _97, _105);
   return _106;
  }
  ...
  if (!_108)   {
   ...
   int32_t _110 = halide_error_buffer_extents_negative(_ucon, "Input buffer input", 1, _109);
   return _110;
  }
  int32_t _111 = _halide_buffer_get_min(_output_buffer, 0);
  bool _112 = _111 <= 0;
  int32_t _113 = _halide_buffer_get_extent(_output_buffer, 0);
  int32_t _114 = _113 + _111;
  bool _115 = 64 <= _114;
  bool _116 = _112 && _115;
  if (!_116)   {
   int32_t _117 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _118 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _119 = _118 + _117;
   int32_t _120 = _119 + -1;
   int32_t _121 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 0, 0, 63, _117, _120);
   return _121;
  }
  int32_t _122 = _halide_buffer_get_extent(_output_buffer, 0);
  bool _123 = 0 <= _122;
  if (!_123)   {
   int32_t _124 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _125 = halide_error_buffer_extents_negative(_ucon, "Output buffer output", 0, _124);
   return _125;
  }
  int32_t _126 = _halide_buffer_get_min(_output_buffer, 1);
  bool _127 = _126 <= 0;
  int32_t _128 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _129 = _128 + _126;
  bool _130 = 64 <= _129;
  bool _131 = _127 && _130;
  if (!_131)   {
   int32_t _132 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _133 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _134 = _133 + _132;
   int32_t _135 = _134 + -1;
   int32_t _136 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 1, 0, 63, _132, _135);
   return _136;
  }
  int32_t _137 = _halide_buffer_get_extent(_output_buffer, 1);
  bool _138 = 0 <= _137;
  if (!_138)   {
   int32_t _139 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _140 = halide_error_buffer_extents_negative(_ucon, "Output buffer output", 1, _139);
   return _140;
  }
  int32_t _141 = _halide_buffer_get_stride(_input_buffer, 0);
  bool _142 = _141 == 1;
  if (!_142)   {
   int32_t _143 = _halide_buffer_get_stride(_input_buffer, 0);
   int32_t _144 = halide_error_constraint_violated(_ucon, "input.stride.0", _143, "1", 1);
   return _144;
  }
  int32_t _145 = _halide_buffer_get_stride(_output_buffer, 0);
  bool _146 = _145 == 1;
  if (!_146)   {
   int32_t _147 = _halide_buffer_get_stride(_output_buffer, 0);
   int32_t _148 = halide_error_constraint_violated(_ucon, "output.stride.0", _147, "1", 1);
   return _148;
  }
  int32_t _149 = _halide_buffer_get_extent(_input_buffer, 0);
  int64_t _150 = (int64_t)(_149);
  int64_t _151 = (int64_t)(0);
  int64_t _152 = _151 - _150;
  bool _153 = _150 > _151;
  int64_t _154 = (int64_t)(_153 ? _150 : _152);
  uint64_t _155 = (uint64_t)(_154);
  uint64_t _156 = _155;
  uint64_t _157 = (uint64_t)(2147483647);
  bool _158 = _156 <= _157;
  if (!_158)   {
   int32_t _159 = _halide_buffer_get_extent(_input_buffer, 0);
   int64_t _160 = (int64_t)(_159);
   ...
   int32_t _168 = halide_error_buffer_allocation_too_large(_ucon, "input", _166, _167);
   return _168;
  }
  int32_t _169 = _halide_buffer_get_extent(_input_buffer, 1);
  int64_t _170 = (int64_t)(_169);
  int32_t _171 = _halide_buffer_get_stride(_input_buffer, 1);
  int64_t _172 = (int64_t)(_171);
  int64_t _173 = _170 * _172;
  ...
  bool _181 = _179 <= _180;
  if (!_181)   {
   int32_t _182 = _halide_buffer_get_extent(_input_buffer, 1);
   int64_t _183 = (int64_t)(_182);
   int32_t _184 = _halide_buffer_get_stride(_input_buffer, 1);
   int64_t _185 = (int64_t)(_184);
   int64_t _186 = _183 * _185;
   ...
   int32_t _194 = halide_error_buffer_allocation_too_large(_ucon, "input", _192, _193);
   return _194;
  }
  int32_t _195 = _halide_buffer_get_extent(_input_buffer, 1);
  int64_t _196 = (int64_t)(_195);
  int32_t _197 = _halide_buffer_get_extent(_input_buffer, 0);
  int64_t _198 = (int64_t)(_197);
  int64_t _199 = _196 * _198;
  int64_t _200 = (int64_t)(2147483647);
  bool _201 = _199 <= _200;
  if (!_201)   {
   int32_t _202 = _halide_buffer_get_extent(_input_buffer, 1);
   int64_t _203 = (int64_t)(_202);
   int32_t _204 = _halide_buffer_get_extent(_input_buffer, 0);
   int64_t _205 = (int64_t)(_204);
   int64_t _206 = _203 * _205;
   int64_t _207 = (int64_t)(2147483647);
   int32_t _208 = halide_error_buffer_extents_too_large(_ucon, "input", _206, _207);
   return _208;
  }
  int32_t _209 = _halide_buffer_get_extent(_output_buffer, 0);
  ...
  int32_t _231 = _halide_buffer_get_stride(_output_buffer, 1);
  int64_t _232 = (int64_t)(_231);
  int64_t _233 = _230 * _232;
  int64_t _234 = (int64_t)(0);
  int64_t _235 = _234 - _233;
  bool _236 = _233 > _234;
  int64_t _237 = (int64_t)(_236 ? _233 : _235);
  uint64_t _238 = (uint64_t)(_237);
  uint64_t _239 = _238;
  uint64_t _240 = (uint64_t)(2147483647);
  bool _241 = _239 <= _240;
  if (!_241)   {
   int32_t _242 = _halide_buffer_get_extent(_output_buffer, 1);
   int64_t _243 = (int64_t)(_242);
   int32_t _244 = _halide_buffer_get_stride(_output_buffer, 1);
   int64_t _245 = (int64_t)(_244);
   int64_t _246 = _243 * _245;
   int64_t _247 = (int64_t)(0);
   int64_t _248 = _247 - _246;
   bool _249 = _246 > _247;
   int64_t _250 = (int64_t)(_249 ? _246 : _248);
   uint64_t _251 = (uint64_t)(_250);
   uint64_t _252 = _251;
   uint64_t _253 = (uint64_t)(2147483647);
   int32_t _254 = halide_error_buffer_allocation_too_large(_ucon, "output", _252, _253);
   return _254;
  }
  int32_t _255 = _halide_buffer_get_extent(_output_buffer, 1);
  int64_t _256 = (int64_t)(_255);
  int32_t _257 = _halide_buffer_get_extent(_output_buffer, 0);
  int64_t _258 = (int64_t)(_257);
  int64_t _259 = _256 * _258;
  int64_t _260 = (int64_t)(2147483647);
  bool _261 = _259 <= _260;
  if (!_261)   {
   int32_t _262 = _halide_buffer_get_extent(_output_buffer, 1);
   int64_t _263 = (int64_t)(_262);
   int32_t _264 = _halide_buffer_get_extent(_output_buffer, 0);
   int64_t _265 = (int64_t)(_264);
   int64_t _266 = _263 * _265;
   int64_t _267 = (int64_t)(2147483647);
   int32_t _268 = halide_error_buffer_extents_too_large(_ucon, "output", _266, _267);
   return _268;
  }
  void *_269 = _halide_buffer_get_host(_input_buffer);
  uint64_t _270 = (uint64_t)(0);
  void *_271 = (void *)(_270);
  bool _272 = _269 != _271;
  if (!_272)   {
   int32_t _273 = halide_error_host_is_null(_ucon, "Input buffer input");
   return _273;
  }
  void *_274 = _halide_buffer_get_host(_output_buffer);
  uint64_t _275 = (uint64_t)(0);
  void *_276 = (void *)(_275);
  bool _277 = _274 != _276;
  if (!_277)   {
   int32_t _278 = halide_error_host_is_null(_ucon, "Output buffer output");
   return _278;
  }
  ...
  RDAI_MemObject *_hw_input_stencil = RDAI_mem_shared_allocate(11250);
  // produce hw_input.stencil
  int32_t _279 = _halide_buffer_get_min(_input_buffer, 1);
  int32_t _280 = _halide_buffer_get_extent(_input_buffer, 1);
  int32_t _281 = ::halide_cpp_max(_280, 0);
  int32_t _282 = _279 + _281;
  int32_t _283 = ::halide_cpp_min(_279, 68);
  int32_t _284 = ::halide_cpp_max(_283, -7);
  int32_t _285 = _284 + 7;
  for (int _hw_input_s0_y = -7; _hw_input_s0_y < -7 + _285; _hw_input_s0_y++)
  {
   for (int _hw_input_s0_x = -7; _hw_input_s0_x < -7 + 75; _hw_input_s0_x++)
   {
    // Provision buffer _hw_input_stencil
    int32_t _286 = _halide_buffer_get_min(_input_buffer, 0);
    int32_t _287 = _halide_buffer_get_extent(_input_buffer, 0);
    int32_t _288 = _287 + _286;
    int32_t _289 = _288 + -1;
    int32_t _290 = ::halide_cpp_min(_289, _hw_input_s0_x);
    int32_t _291 = ::halide_cpp_max(_286, _290);
    int32_t _292 = _halide_buffer_get_stride(_input_buffer, 1);
    int32_t _293 = _halide_buffer_get_min(_input_buffer, 1);
    int32_t _294 = _halide_buffer_get_extent(_input_buffer, 1);
    int32_t _295 = _294 + _293;
    int32_t _296 = _295 + -1;
    int32_t _297 = ::halide_cpp_min(_296, _hw_input_s0_y);
    int32_t _298 = ::halide_cpp_max(_293, _297);
    int32_t _299 = _292 * _298;
    int32_t _300 = _293 * _292;
    int32_t _301 = _286 + _300;
    int32_t _302 = _299 - _301;
    int32_t _303 = _291 + _302;
...
_305;
    ...
    int32_t _306 = _hw_input_s0_y * 75;
    int32_t _307 = _306 + _hw_input_s0_x;
    int32_t _308 = _307 + 532;
_308;
    _hw_input_stencil_host[_308] = _305;
   } // for _hw_input_s0_x
  } // for _hw_input_s0_y
  int32_t _309 = ::halide_cpp_min(_279, 68);
  int32_t _310 = ::halide_cpp_max(_309, -7);
  int32_t _311 = ::halide_cpp_min(_282, 68);
  int32_t _312 = ::halide_cpp_max(_311, -7);
  int32_t _313 = _312 - _310;
  for (int _hw_input_s0_y = _310; _hw_input_s0_y < _310 + _313; _hw_input_s0_y++)
  {
   int32_t _314 = _halide_buffer_get_min(_input_buffer, 0);
   int32_t _315 = _halide_buffer_get_extent(_input_buffer, 0);
   int32_t _316 = ::halide_cpp_max(_315, 0);
   int32_t _317 = _314 + _316;
   int32_t _318 = ::halide_cpp_min(_314, 68);
   int32_t _319 = ::halide_cpp_max(_318, -7);
   int32_t _320 = _319 + 7;
   for (int _hw_input_s0_x = -7; _hw_input_s0_x < -7 + _320; _hw_input_s0_x++)
   {
    // Provision buffer _hw_input_stencil
    int32_t _321 = _halide_buffer_get_min(_input_buffer, 0);
    int32_t _322 = _halide_buffer_get_extent(_input_buffer, 0);
    int32_t _323 = _322 + _321;
    int32_t _324 = _323 + -1;
    int32_t _325 = ::halide_cpp_min(_324, _hw_input_s0_x);
    int32_t _326 = ::halide_cpp_max(_321, _325);
    int32_t _327 = _halide_buffer_get_stride(_input_buffer, 1);
    int32_t _328 = _327 * _hw_input_s0_y;
    int32_t _329 = _halide_buffer_get_min(_input_buffer, 1);
    int32_t _330 = _329 * _327;
    int32_t _331 = _321 + _330;
    int32_t _332 = _328 - _331;
    int32_t _333 = _326 + _332;
    uint8_t _334 = ((const uint8_t *)_input)[_333];
    uint16_t _335 = (uint16_t)(_334);
_335;
    uint16_t *_hw_input_stencil_host = (uint16_t *) _hw_input_stencil->host_ptr;
    int32_t _336 = _hw_input_s0_y * 75;
    int32_t _337 = _336 + _hw_input_s0_x;
    int32_t _338 = _337 + 532;
_338;
    _hw_input_stencil_host[_338] = _335;
   } // for _hw_input_s0_x
   int32_t _339 = ::halide_cpp_min(_314, 68);
   int32_t _340 = ::halide_cpp_max(_339, -7);
   int32_t _341 = ::halide_cpp_min(_317, 68);
   int32_t _342 = ::halide_cpp_max(_341, -7);
   int32_t _343 = _342 - _340;
   for (int _hw_input_s0_x = _340; _hw_input_s0_x < _340 + _343; _hw_input_s0_x++)
   {
    // Provision buffer _hw_input_stencil
    int32_t _344 = _halide_buffer_get_stride(_input_buffer, 1);
    int32_t _345 = _344 * _hw_input_s0_y;
    int32_t _346 = _halide_buffer_get_min(_input_buffer, 0);
    int32_t _347 = _halide_buffer_get_min(_input_buffer, 1);
    int32_t _348 = _347 * _344;
    int32_t _349 = _346 + _348;
    int32_t _350 = _345 - _349;
    int32_t _351 = _350 + _hw_input_s0_x;
    uint8_t _352 = ((const uint8_t *)_input)[_351];
    uint16_t _353 = (uint16_t)(_352);
_353;
    uint16_t *_hw_input_stencil_host = (uint16_t *) _hw_input_stencil->host_ptr;
    int32_t _354 = _hw_input_s0_y * 75;
    int32_t _355 = _354 + _hw_input_s0_x;
    int32_t _356 = _355 + 532;
_356;
    _hw_input_stencil_host[_356] = _353;
   } // for _hw_input_s0_x
   int32_t _357 = ::halide_cpp_min(_317, 68);
   int32_t _358 = ::halide_cpp_max(_357, -7);
   int32_t _359 = 68 - _358;
   for (int _hw_input_s0_x = _358; _hw_input_s0_x < _358 + _359; _hw_input_s0_x++)
   {
    // Provision buffer _hw_input_stencil
    int32_t _360 = _halide_buffer_get_min(_input_buffer, 0);
    int32_t _361 = _halide_buffer_get_extent(_input_buffer, 0);
    int32_t _362 = _361 + _360;
    int32_t _363 = _362 + -1;
    int32_t _364 = ::halide_cpp_min(_363, _hw_input_s0_x);
    int32_t _365 = ::halide_cpp_max(_360, _364);
    int32_t _366 = _halide_buffer_get_stride(_input_buffer, 1);
    int32_t _367 = _366 * _hw_input_s0_y;
    int32_t _368 = _halide_buffer_get_min(_input_buffer, 1);
    int32_t _369 = _368 * _366;
    int32_t _370 = _360 + _369;
    int32_t _371 = _367 - _370;
    int32_t _372 = _365 + _371;
    uint8_t _373 = ((const uint8_t *)_input)[_372];
    uint16_t _374 = (uint16_t)(_373);
_374;
    uint16_t *_hw_input_stencil_host = (uint16_t *) _hw_input_stencil->host_ptr;
    int32_t _375 = _hw_input_s0_y * 75;
    int32_t _376 = _375 + _hw_input_s0_x;
    int32_t _377 = _376 + 532;
_377;
    _hw_input_stencil_host[_377] = _374;
   } // for _hw_input_s0_x
  } // for _hw_input_s0_y
  int32_t _378 = ::halide_cpp_min(_282, 68);
  int32_t _379 = ::halide_cpp_max(_378, -7);
  int32_t _380 = 68 - _379;
  for (int _hw_input_s0_y = _379; _hw_input_s0_y < _379 + _380; _hw_input_s0_y++)
  {
   for (int _hw_input_s0_x = -7; _hw_input_s0_x < -7 + 75; _hw_input_s0_x++)
   {
    // Provision buffer _hw_input_stencil
    int32_t _381 = _halide_buffer_get_min(_input_buffer, 0);
    int32_t _382 = _halide_buffer_get_extent(_input_buffer, 0);
    int32_t _383 = _382 + _381;
    int32_t _384 = _383 + -1;
    int32_t _385 = ::halide_cpp_min(_384, _hw_input_s0_x);
    int32_t _386 = ::halide_cpp_max(_381, _385);
    int32_t _387 = _halide_buffer_get_stride(_input_buffer, 1);
    int32_t _388 = _halide_buffer_get_min(_input_buffer, 1);
    int32_t _389 = _halide_buffer_get_extent(_input_buffer, 1);
    int32_t _390 = _389 + _388;
    int32_t _391 = _390 + -1;
    int32_t _392 = ::halide_cpp_min(_391, _hw_input_s0_y);
    int32_t _393 = ::halide_cpp_max(_388, _392);
    int32_t _394 = _387 * _393;
    int32_t _395 = _388 * _387;
    int32_t _396 = _381 + _395;
    int32_t _397 = _394 - _396;
    int32_t _398 = _386 + _397;
    uint8_t _399 = ((const uint8_t *)_input)[_398];
    uint16_t _400 = (uint16_t)(_399);
_400;
    uint16_t *_hw_input_stencil_host = (uint16_t *) _hw_input_stencil->host_ptr;
    int32_t _401 = _hw_input_s0_y * 75;
    int32_t _402 = _401 + _hw_input_s0_x;
    int32_t _403 = _402 + 532;
_403;
    _hw_input_stencil_host[_403] = _400;
   } // for _hw_input_s0_x
  } // for _hw_input_s0_y
  ...
  RDAI_VLNV device_vlnv = {{"aha"}, {"halide_hardware"}, {"laplacian_pyramid"}, 1};
  ...
  int32_t _838 = _halide_buffer_get_min(_output_buffer, 1);
  bool _839 = 0 <= _838;
  int32_t _840 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _841 = _840 + _838;
  bool _842 = _841 <= 64;
  bool _843 = _839 && _842;
  if (!_843)   {
   int32_t _844 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _845 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _846 = _845 + _844;
   int32_t _847 = _846 + -1;
   int32_t _848 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 63, _844, _847);
   return _848;
  }
  int32_t _849 = _halide_buffer_get_min(_output_buffer, 0);
  bool _850 = 0 <= _849;
  int32_t _851 = _halide_buffer_get_extent(_output_buffer, 0);
  int32_t _852 = _851 + _849;
  bool _853 = _852 <= 64;
  bool _854 = _850 && _853;
  if (!_854)   {
   int32_t _855 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _856 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _857 = _856 + _855;
   int32_t _858 = _857 + -1;
   int32_t _859 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 63, _855, _858);
   return _859;
  }
  // produce output
  for (int _output_s0_y = 0; _output_s0_y < 0 + 64; _output_s0_y++)
  {
   ...
   {
    int32_t _860 = _output_s0_y * 64;
    int32_t _861 = _860 + _output_s0_x;
_861;
    uint16_t *_hw_output_stencil_host = (uint16_t *) _hw_output_stencil->host_ptr;
    uint16_t _862 = _hw_output_stencil_host[_861];
    uint8_t _863 = (uint8_t)(_862);
    int32_t _864 = _halide_buffer_get_stride(_output_buffer, 1);
    int32_t _865 = _864 * _output_s0_y;
    int32_t _866 = _865 + _output_s0_x;
    ((uint8_t *)_output)[_866] = _863;
   } // for _output_s0_x
  } // for _output_s0_y
