...
int camera_pipeline_clockwork(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
 ...
 if (_25)
 {
  ...
  if (!_81)   {
   ...
   int32_t _84 = _83 + _82;
   int32_t _85 = _84 + -1;
   int32_t _86 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 0, 0, 55, _82, _85);
   return _86;
  }
  ...
  if (!_96)   {
   ...
   int32_t _99 = _98 + _97;
   int32_t _100 = _99 + -1;
   int32_t _101 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 1, 0, 55, _97, _100);
   return _101;
  }
  ...
  for (int _hw_input_s0_y = -4; _hw_input_s0_y < -4 + 64; _hw_input_s0_y++)
  {
   for (int _hw_input_s0_x = -4; _hw_input_s0_x < -4 + 64; _hw_input_s0_x++)
   {
...
_316;
    ...
    int32_t _317 = _hw_input_s0_y * 64;
    int32_t _318 = _317 + _hw_input_s0_x;
    int32_t _319 = _318 + 260;
_319;
  ...
  RDAI_MemObject *_hw_output_stencil = RDAI_mem_shared_allocate(18816);
  ...
  RDAI_VLNV device_vlnv = {{"aha"}, {"halide_hardware"}, {"camera_pipeline"}, 1};
  ...
  int32_t _5516 = _halide_buffer_get_min(_output_buffer, 1);
  bool _5517 = 0 <= _5516;
  int32_t _5518 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _5519 = _5518 + _5516;
  bool _5520 = _5519 <= 56;
  bool _5521 = _5517 && _5520;
  if (!_5521)   {
   int32_t _5522 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _5523 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _5524 = _5523 + _5522;
   int32_t _5525 = _5524 + -1;
   int32_t _5526 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 55, _5522, _5525);
   return _5526;
  }
  int32_t _5527 = _halide_buffer_get_min(_output_buffer, 0);
  bool _5528 = 0 <= _5527;
  int32_t _5529 = _halide_buffer_get_extent(_output_buffer, 0);
  int32_t _5530 = _5529 + _5527;
  bool _5531 = _5530 <= 56;
  bool _5532 = _5528 && _5531;
  if (!_5532)   {
   int32_t _5533 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _5534 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _5535 = _5534 + _5533;
   int32_t _5536 = _5535 + -1;
   int32_t _5537 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 55, _5533, _5536);
   return _5537;
  }
  int32_t _5538 = _halide_buffer_get_min(_output_buffer, 2);
  bool _5539 = 0 <= _5538;
  int32_t _5540 = _halide_buffer_get_extent(_output_buffer, 2);
  int32_t _5541 = _5540 + _5538;
  bool _5542 = _5541 <= 3;
  bool _5543 = _5539 && _5542;
  if (!_5543)   {
   int32_t _5544 = _halide_buffer_get_min(_output_buffer, 2);
   int32_t _5545 = _halide_buffer_get_extent(_output_buffer, 2);
   int32_t _5546 = _5545 + _5544;
   int32_t _5547 = _5546 + -1;
   int32_t _5548 = halide_error_explicit_bounds_too_small(_ucon, "c", "output", 0, 2, _5544, _5547);
   return _5548;
  }
  // produce output
  for (int _output_s0_c = 0; _output_s0_c < 0 + 3; _output_s0_c++)
  {
   for (int _output_s0_y = 0; _output_s0_y < 0 + 56; _output_s0_y++)
   {
    for (int _output_s0_x = 0; _output_s0_x < 0 + 56; _output_s0_x++)
    {
     int32_t _5549 = _output_s0_y * 168;
     int32_t _5550 = _output_s0_x * 3;
     int32_t _5551 = _5550 + _output_s0_c;
     int32_t _5552 = _5549 + _5551;
_5552;
     uint16_t *_hw_output_stencil_host = (uint16_t *) _hw_output_stencil->host_ptr;
     uint16_t _5553 = _hw_output_stencil_host[_5552];
     uint8_t _5554 = (uint8_t)(_5553);
     int32_t _5555 = _halide_buffer_get_stride(_output_buffer, 2);
     int32_t _5556 = _5555 * _output_s0_c;
     int32_t _5557 = _halide_buffer_get_stride(_output_buffer, 1);
     int32_t _5558 = _5557 * _output_s0_y;
     int32_t _5559 = _5556 + _5558;
     int32_t _5560 = _5559 + _output_s0_x;
     ((uint8_t *)_output)[_5560] = _5554;
    } // for _output_s0_x
   } // for _output_s0_y
  } // for _output_s0_c
