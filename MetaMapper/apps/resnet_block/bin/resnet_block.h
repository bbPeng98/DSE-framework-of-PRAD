#ifndef HALIDE_____bin___resnet_block_h
#define HALIDE_____bin___resnet_block_h
#include <stdint.h>
...
int resnet_block(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_kernel_buffer, struct halide_buffer_t *_kernel2_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int resnet_block_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *resnet_block_metadata() HALIDE_FUNCTION_ATTRS;
