...
prog conv_6_6() {
  prog prg;
  prg.compute_unit_file = "conv_6_6_compute.h";
  prg.name = "conv_6_6";
...
////producing conv.stencil
  auto conv_s0_y = prg.add_loop("conv_s0_y", 0, 59);
  auto conv_s0_x = conv_s0_y->add_loop("conv_s0_x", 0, 59);
...
//store is: conv.stencil(conv_s0_x, conv_s0_y) = (uint16)0
  ...
  auto conv_s1_y = prg.add_loop("conv_s1_y", 0, 59);
  auto conv_s1_x = conv_s1_y->add_loop("conv_s1_x", 0, 59);
...
//consuming conv.stencil
  auto hw_output_s0_y_yi = prg.add_loop("hw_output_s0_y_yi", 0, 59);
  auto hw_output_s0_x_xi = hw_output_s0_y_yi->add_loop("hw_output_s0_x_xi", 0, 59);
