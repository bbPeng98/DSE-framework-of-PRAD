...
int conv_6_6_clockwork(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
 ...
 if (_25)
 {
  ...
  if (!_81)   {
   ...
   int32_t _84 = _83 + _82;
   int32_t _85 = _84 + -1;
   int32_t _86 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 0, 0, 58, _82, _85);
   return _86;
  }
  ...
  if (!_96)   {
   ...
   int32_t _99 = _98 + _97;
   int32_t _100 = _99 + -1;
   int32_t _101 = halide_error_access_out_of_bounds(_ucon, "Output buffer output", 1, 0, 58, _97, _100);
   return _101;
  }
...
_255;
  ...
  RDAI_MemObject *_hw_output_stencil = RDAI_mem_shared_allocate(6962);
  ...
  RDAI_VLNV device_vlnv = {{"aha"}, {"halide_hardware"}, {"conv_6_6"}, 1};
  ...
  int32_t _607 = _halide_buffer_get_min(_output_buffer, 1);
  bool _608 = 0 <= _607;
  int32_t _609 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _610 = _609 + _607;
  bool _611 = _610 <= 59;
  bool _612 = _608 && _611;
  if (!_612)   {
   int32_t _613 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _614 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _615 = _614 + _613;
   int32_t _616 = _615 + -1;
   int32_t _617 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 58, _613, _616);
   return _617;
  }
  int32_t _618 = _halide_buffer_get_min(_output_buffer, 0);
  bool _619 = 0 <= _618;
  int32_t _620 = _halide_buffer_get_extent(_output_buffer, 0);
  int32_t _621 = _620 + _618;
  bool _622 = _621 <= 59;
  bool _623 = _619 && _622;
  if (!_623)   {
   int32_t _624 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _625 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _626 = _625 + _624;
   int32_t _627 = _626 + -1;
   int32_t _628 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 58, _624, _627);
   return _628;
  }
  // produce output
  for (int _output_s0_y = 0; _output_s0_y < 0 + 59; _output_s0_y++)
  {
   for (int _output_s0_x = 0; _output_s0_x < 0 + 59; _output_s0_x++)
   {
    int32_t _629 = _output_s0_y * 59;
    int32_t _630 = _629 + _output_s0_x;
_630;
    uint16_t *_hw_output_stencil_host = (uint16_t *) _hw_output_stencil->host_ptr;
    uint16_t _631 = _hw_output_stencil_host[_630];
    uint8_t _632 = (uint8_t)(_631);
    int32_t _633 = _halide_buffer_get_stride(_output_buffer, 1);
    int32_t _634 = _633 * _output_s0_y;
    int32_t _635 = _634 + _output_s0_x;
    ((uint8_t *)_output)[_635] = _632;
   } // for _output_s0_x
  } // for _output_s0_y
