#ifndef HALIDE_____bin___cascade_clockwork_h
#define HALIDE_____bin___cascade_clockwork_h
#include <stdint.h>
...
int cascade_clockwork_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *cascade_clockwork_metadata() HALIDE_FUNCTION_ATTRS;
