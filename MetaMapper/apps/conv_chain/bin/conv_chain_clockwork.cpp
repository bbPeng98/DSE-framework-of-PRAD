...
int conv_chain_clockwork(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
...
_255;
  ...
  RDAI_VLNV device_vlnv = {{"aha"}, {"halide_hardware"}, {"conv_chain"}, 1};
  ...
  int32_t _543 = _halide_buffer_get_min(_output_buffer, 1);
  bool _544 = 0 <= _543;
  int32_t _545 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _546 = _545 + _543;
  bool _547 = _546 <= 58;
  bool _548 = _544 && _547;
  if (!_548)   {
   int32_t _549 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _550 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _551 = _550 + _549;
   int32_t _552 = _551 + -1;
   int32_t _553 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 57, _549, _552);
   return _553;
  }
  int32_t _554 = _halide_buffer_get_min(_output_buffer, 0);
  bool _555 = 0 <= _554;
  int32_t _556 = _halide_buffer_get_extent(_output_buffer, 0);
  int32_t _557 = _556 + _554;
  bool _558 = _557 <= 58;
  bool _559 = _555 && _558;
  if (!_559)   {
   int32_t _560 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _561 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _562 = _561 + _560;
   int32_t _563 = _562 + -1;
   int32_t _564 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 57, _560, _563);
   return _564;
  }
  // produce output
  for (int _output_s0_y = 0; _output_s0_y < 0 + 58; _output_s0_y++)
  {
   ...
   {
    int32_t _565 = _output_s0_y * 58;
    int32_t _566 = _565 + _output_s0_x;
_566;
    uint16_t *_hw_output_stencil_host = (uint16_t *) _hw_output_stencil->host_ptr;
    uint16_t _567 = _hw_output_stencil_host[_566];
    uint8_t _568 = (uint8_t)(_567);
    int32_t _569 = _halide_buffer_get_stride(_output_buffer, 1);
    int32_t _570 = _569 * _output_s0_y;
    int32_t _571 = _570 + _output_s0_x;
    ((uint8_t *)_output)[_571] = _568;
   } // for _output_s0_x
  } // for _output_s0_y
