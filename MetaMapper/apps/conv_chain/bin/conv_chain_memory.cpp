...
prog conv_chain() {
  prog prg;
  prg.compute_unit_file = "conv_chain_compute.h";
  prg.name = "conv_chain";
...
////producing conv0.stencil
  auto conv0_s0_y = prg.add_loop("conv0_s0_y", 0, 62);
  auto conv0_s0_x = conv0_s0_y->add_loop("conv0_s0_x", 0, 62);

//store is: conv0.stencil(conv0_s0_x, conv0_s0_y) = (uint16)0
  auto hcompute_conv0_stencil = conv0_s0_x->add_op("op_hcompute_conv0_stencil");
  hcompute_conv0_stencil->add_function("hcompute_conv0_stencil");
  prg.buffer_port_widths["conv0_stencil"] = 16;
  hcompute_conv0_stencil->add_store("conv0_stencil", "conv0_s0_y", "conv0_s0_x");
  auto conv0_s1_y = prg.add_loop("conv0_s1_y", 0, 62);
  auto conv0_s1_x_x = conv0_s1_y->add_loop("conv0_s1_x_x", 0, 62);
...
//store is: conv0.stencil(conv0_s1_x_x, conv0_s1_y) = ((hw_input_global_wrapper.stencil(conv0_s1_x_x, conv0_s1_y)*(uint16)17) + (conv0.stencil(conv0_s1_x_x, conv0_s1_y) + ((hw_input_global_wrapper.stencil((conv0_s1_x_x + 1), conv0_s1_y)*(uint16)7) + ((hw_input_global_wrapper.stencil((conv0_s1_x_x + 2), conv0_s1_y)*(uint16)5) + ((hw_input_global_wrapper.stencil(conv0_s1_x_x, (conv0_s1_y + 1))*(uint16)4) + ((hw_input_global_wrapper.stencil((conv0_s1_x_x + 1), (conv0_s1_y + 1))*(uint16)19) + ((hw_input_global_wrapper.stencil((conv0_s1_x_x + 2), (conv0_s1_y + 1))*(uint16)21) + ((hw_input_global_wrapper.stencil(conv0_s1_x_x, (conv0_s1_y + 2))*(uint16)6) + ((hw_input_global_wrapper.stencil((conv0_s1_x_x + 2), (conv0_s1_y + 2))*(uint16)15) + (hw_input_global_wrapper.stencil((conv0_s1_x_x + 1), (conv0_s1_y + 2))*(uint16)4))))))))))
  auto hcompute_conv0_stencil_1 = conv0_s1_x_x->add_op("op_hcompute_conv0_stencil_1");
  hcompute_conv0_stencil_1->add_function("hcompute_conv0_stencil_1");
  hcompute_conv0_stencil_1->add_load("conv0_stencil", "conv0_s1_y", "conv0_s1_x_x");
  hcompute_conv0_stencil_1->add_load("hw_input_global_wrapper_stencil", "conv0_s1_y", "conv0_s1_x_x");
  hcompute_conv0_stencil_1->add_load("hw_input_global_wrapper_stencil", "conv0_s1_y", "(conv0_s1_x_x + 1)");
  hcompute_conv0_stencil_1->add_load("hw_input_global_wrapper_stencil", "conv0_s1_y", "(conv0_s1_x_x + 2)");
  hcompute_conv0_stencil_1->add_load("hw_input_global_wrapper_stencil", "(conv0_s1_y + 1)", "conv0_s1_x_x");
  hcompute_conv0_stencil_1->add_load("hw_input_global_wrapper_stencil", "(conv0_s1_y + 1)", "(conv0_s1_x_x + 1)");
  hcompute_conv0_stencil_1->add_load("hw_input_global_wrapper_stencil", "(conv0_s1_y + 1)", "(conv0_s1_x_x + 2)");
  hcompute_conv0_stencil_1->add_load("hw_input_global_wrapper_stencil", "(conv0_s1_y + 2)", "conv0_s1_x_x");
  hcompute_conv0_stencil_1->add_load("hw_input_global_wrapper_stencil", "(conv0_s1_y + 2)", "(conv0_s1_x_x + 2)");
  hcompute_conv0_stencil_1->add_load("hw_input_global_wrapper_stencil", "(conv0_s1_y + 2)", "(conv0_s1_x_x + 1)");
  hcompute_conv0_stencil_1->add_store("conv0_stencil", "conv0_s1_y", "conv0_s1_x_x");

//consuming conv0.stencil
////producing conv1.stencil
  auto conv1_s0_y = prg.add_loop("conv1_s0_y", 0, 60);
  auto conv1_s0_x = conv1_s0_y->add_loop("conv1_s0_x", 0, 60);
...
//store is: conv1.stencil(conv1_s0_x, conv1_s0_y) = (uint16)0
  ...
  auto conv1_s1_y = prg.add_loop("conv1_s1_y", 0, 60);
  auto conv1_s1_x_x = conv1_s1_y->add_loop("conv1_s1_x_x", 0, 60);
...
//store is: conv1.stencil(conv1_s1_x_x, conv1_s1_y) = ((conv0.stencil(conv1_s1_x_x, conv1_s1_y)*(uint16)17) + (conv1.stencil(conv1_s1_x_x, conv1_s1_y) + ((conv0.stencil((conv1_s1_x_x + 1), conv1_s1_y)*(uint16)7) + ((conv0.stencil((conv1_s1_x_x + 2), conv1_s1_y)*(uint16)5) + ((conv0.stencil(conv1_s1_x_x, (conv1_s1_y + 1))*(uint16)4) + ((conv0.stencil((conv1_s1_x_x + 1), (conv1_s1_y + 1))*(uint16)19) + ((conv0.stencil((conv1_s1_x_x + 2), (conv1_s1_y + 1))*(uint16)21) + ((conv0.stencil(conv1_s1_x_x, (conv1_s1_y + 2))*(uint16)6) + ((conv0.stencil((conv1_s1_x_x + 2), (conv1_s1_y + 2))*(uint16)15) + (conv0.stencil((conv1_s1_x_x + 1), (conv1_s1_y + 2))*(uint16)4))))))))))
  auto hcompute_conv1_stencil_1 = conv1_s1_x_x->add_op("op_hcompute_conv1_stencil_1");
  hcompute_conv1_stencil_1->add_function("hcompute_conv1_stencil_1");
  hcompute_conv1_stencil_1->add_load("conv0_stencil", "(conv1_s1_y + 2)", "(conv1_s1_x_x + 1)");
  hcompute_conv1_stencil_1->add_load("conv0_stencil", "conv1_s1_y", "conv1_s1_x_x");
  hcompute_conv1_stencil_1->add_load("conv0_stencil", "conv1_s1_y", "(conv1_s1_x_x + 1)");
  hcompute_conv1_stencil_1->add_load("conv0_stencil", "conv1_s1_y", "(conv1_s1_x_x + 2)");
  hcompute_conv1_stencil_1->add_load("conv0_stencil", "(conv1_s1_y + 1)", "conv1_s1_x_x");
  hcompute_conv1_stencil_1->add_load("conv0_stencil", "(conv1_s1_y + 1)", "(conv1_s1_x_x + 1)");
  hcompute_conv1_stencil_1->add_load("conv0_stencil", "(conv1_s1_y + 1)", "(conv1_s1_x_x + 2)");
  hcompute_conv1_stencil_1->add_load("conv0_stencil", "(conv1_s1_y + 2)", "conv1_s1_x_x");
  hcompute_conv1_stencil_1->add_load("conv0_stencil", "(conv1_s1_y + 2)", "(conv1_s1_x_x + 2)");
  hcompute_conv1_stencil_1->add_load("conv1_stencil", "conv1_s1_y", "conv1_s1_x_x");
  hcompute_conv1_stencil_1->add_store("conv1_stencil", "conv1_s1_y", "conv1_s1_x_x");

//consuming conv1.stencil
////producing conv2.stencil
  auto conv2_s0_y = prg.add_loop("conv2_s0_y", 0, 58);
  auto conv2_s0_x = conv2_s0_y->add_loop("conv2_s0_x", 0, 58);
...
//store is: conv2.stencil(conv2_s0_x, conv2_s0_y) = (uint16)0
  ...
  auto conv2_s1_y = prg.add_loop("conv2_s1_y", 0, 58);
  auto conv2_s1_x_x = conv2_s1_y->add_loop("conv2_s1_x_x", 0, 58);
...
//store is: conv2.stencil(conv2_s1_x_x, conv2_s1_y) = ((conv1.stencil(conv2_s1_x_x, conv2_s1_y)*(uint16)17) + (conv2.stencil(conv2_s1_x_x, conv2_s1_y) + ((conv1.stencil((conv2_s1_x_x + 1), conv2_s1_y)*(uint16)7) + ((conv1.stencil((conv2_s1_x_x + 2), conv2_s1_y)*(uint16)5) + ((conv1.stencil(conv2_s1_x_x, (conv2_s1_y + 1))*(uint16)4) + ((conv1.stencil((conv2_s1_x_x + 1), (conv2_s1_y + 1))*(uint16)19) + ((conv1.stencil((conv2_s1_x_x + 2), (conv2_s1_y + 1))*(uint16)21) + ((conv1.stencil(conv2_s1_x_x, (conv2_s1_y + 2))*(uint16)6) + ((conv1.stencil((conv2_s1_x_x + 2), (conv2_s1_y + 2))*(uint16)15) + (conv1.stencil((conv2_s1_x_x + 1), (conv2_s1_y + 2))*(uint16)4))))))))))
  auto hcompute_conv2_stencil_1 = conv2_s1_x_x->add_op("op_hcompute_conv2_stencil_1");
  hcompute_conv2_stencil_1->add_function("hcompute_conv2_stencil_1");
  hcompute_conv2_stencil_1->add_load("conv1_stencil", "(conv2_s1_y + 2)", "(conv2_s1_x_x + 1)");
  hcompute_conv2_stencil_1->add_load("conv1_stencil", "conv2_s1_y", "conv2_s1_x_x");
  hcompute_conv2_stencil_1->add_load("conv1_stencil", "conv2_s1_y", "(conv2_s1_x_x + 1)");
  hcompute_conv2_stencil_1->add_load("conv1_stencil", "conv2_s1_y", "(conv2_s1_x_x + 2)");
  hcompute_conv2_stencil_1->add_load("conv1_stencil", "(conv2_s1_y + 1)", "conv2_s1_x_x");
  hcompute_conv2_stencil_1->add_load("conv1_stencil", "(conv2_s1_y + 1)", "(conv2_s1_x_x + 1)");
  hcompute_conv2_stencil_1->add_load("conv1_stencil", "(conv2_s1_y + 1)", "(conv2_s1_x_x + 2)");
  hcompute_conv2_stencil_1->add_load("conv1_stencil", "(conv2_s1_y + 2)", "conv2_s1_x_x");
  hcompute_conv2_stencil_1->add_load("conv1_stencil", "(conv2_s1_y + 2)", "(conv2_s1_x_x + 2)");
  hcompute_conv2_stencil_1->add_load("conv2_stencil", "conv2_s1_y", "conv2_s1_x_x");
  hcompute_conv2_stencil_1->add_store("conv2_stencil", "conv2_s1_y", "conv2_s1_x_x");
