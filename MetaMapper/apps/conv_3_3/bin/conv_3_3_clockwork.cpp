...
_255;
  ...
  int32_t _336 = _halide_buffer_get_min(_output_buffer, 1);
  bool _337 = 0 <= _336;
  int32_t _338 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _339 = _338 + _336;
  bool _340 = _339 <= 62;
  bool _341 = _337 && _340;
  if (!_341)   {
   int32_t _342 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _343 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _344 = _343 + _342;
   int32_t _345 = _344 + -1;
   int32_t _346 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 61, _342, _345);
   return _346;
  }
  int32_t _347 = _halide_buffer_get_min(_output_buffer, 0);
  bool _348 = 0 <= _347;
  int32_t _349 = _halide_buffer_get_extent(_output_buffer, 0);
  int32_t _350 = _349 + _347;
  bool _351 = _350 <= 62;
  bool _352 = _348 && _351;
  if (!_352)   {
   int32_t _353 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _354 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _355 = _354 + _353;
   int32_t _356 = _355 + -1;
   int32_t _357 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 61, _353, _356);
   return _357;
  }
  // produce output
  for (int _output_s0_y = 0; _output_s0_y < 0 + 62; _output_s0_y++)
  {
   ...
   {
    int32_t _358 = _output_s0_y * 62;
    int32_t _359 = _358 + _output_s0_x;
_359;
    uint16_t *_hw_output_stencil_host = (uint16_t *) _hw_output_stencil->host_ptr;
    uint16_t _360 = _hw_output_stencil_host[_359];
    uint8_t _361 = (uint8_t)(_360);
    int32_t _362 = _halide_buffer_get_stride(_output_buffer, 1);
    int32_t _363 = _362 * _output_s0_y;
    int32_t _364 = _363 + _output_s0_x;
    ((uint8_t *)_output)[_364] = _361;
   } // for _output_s0_x
  } // for _output_s0_y
