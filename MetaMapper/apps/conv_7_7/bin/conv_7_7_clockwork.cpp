...
int conv_7_7_clockwork(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
...
_255;
  ...
  RDAI_VLNV device_vlnv = {{"aha"}, {"halide_hardware"}, {"conv_7_7"}, 1};
  ...
  int32_t _724 = _halide_buffer_get_min(_output_buffer, 1);
  bool _725 = 0 <= _724;
  int32_t _726 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _727 = _726 + _724;
  bool _728 = _727 <= 58;
  bool _729 = _725 && _728;
  if (!_729)   {
   int32_t _730 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _731 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _732 = _731 + _730;
   int32_t _733 = _732 + -1;
   int32_t _734 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 57, _730, _733);
   return _734;
  }
  int32_t _735 = _halide_buffer_get_min(_output_buffer, 0);
  bool _736 = 0 <= _735;
  int32_t _737 = _halide_buffer_get_extent(_output_buffer, 0);
  int32_t _738 = _737 + _735;
  bool _739 = _738 <= 58;
  bool _740 = _736 && _739;
  if (!_740)   {
   int32_t _741 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _742 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _743 = _742 + _741;
   int32_t _744 = _743 + -1;
   int32_t _745 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 57, _741, _744);
   return _745;
  }
  // produce output
  for (int _output_s0_y = 0; _output_s0_y < 0 + 58; _output_s0_y++)
  {
   ...
   {
    int32_t _746 = _output_s0_y * 58;
    int32_t _747 = _746 + _output_s0_x;
_747;
    uint16_t *_hw_output_stencil_host = (uint16_t *) _hw_output_stencil->host_ptr;
    uint16_t _748 = _hw_output_stencil_host[_747];
    uint8_t _749 = (uint8_t)(_748);
    int32_t _750 = _halide_buffer_get_stride(_output_buffer, 1);
    int32_t _751 = _750 * _output_s0_y;
    int32_t _752 = _751 + _output_s0_x;
    ((uint8_t *)_output)[_752] = _749;
   } // for _output_s0_x
  } // for _output_s0_y
