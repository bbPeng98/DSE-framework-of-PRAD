...
int conv_2_2_clockwork(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
...
_255;
  ...
  RDAI_VLNV device_vlnv = {{"aha"}, {"halide_hardware"}, {"conv_2_2"}, 1};
  ...
  int32_t _294 = _halide_buffer_get_min(_output_buffer, 1);
  bool _295 = 0 <= _294;
  int32_t _296 = _halide_buffer_get_extent(_output_buffer, 1);
  int32_t _297 = _296 + _294;
  bool _298 = _297 <= 63;
  bool _299 = _295 && _298;
  if (!_299)   {
   int32_t _300 = _halide_buffer_get_min(_output_buffer, 1);
   int32_t _301 = _halide_buffer_get_extent(_output_buffer, 1);
   int32_t _302 = _301 + _300;
   int32_t _303 = _302 + -1;
   int32_t _304 = halide_error_explicit_bounds_too_small(_ucon, "y", "output", 0, 62, _300, _303);
   return _304;
  }
  int32_t _305 = _halide_buffer_get_min(_output_buffer, 0);
  bool _306 = 0 <= _305;
  int32_t _307 = _halide_buffer_get_extent(_output_buffer, 0);
  int32_t _308 = _307 + _305;
  bool _309 = _308 <= 63;
  bool _310 = _306 && _309;
  if (!_310)   {
   int32_t _311 = _halide_buffer_get_min(_output_buffer, 0);
   int32_t _312 = _halide_buffer_get_extent(_output_buffer, 0);
   int32_t _313 = _312 + _311;
   int32_t _314 = _313 + -1;
   int32_t _315 = halide_error_explicit_bounds_too_small(_ucon, "x", "output", 0, 62, _311, _314);
   return _315;
  }
  // produce output
  for (int _output_s0_y = 0; _output_s0_y < 0 + 63; _output_s0_y++)
  {
   ...
   {
    int32_t _316 = _output_s0_y * 63;
    int32_t _317 = _316 + _output_s0_x;
_317;
    uint16_t *_hw_output_stencil_host = (uint16_t *) _hw_output_stencil->host_ptr;
    uint16_t _318 = _hw_output_stencil_host[_317];
    uint8_t _319 = (uint8_t)(_318);
    int32_t _320 = _halide_buffer_get_stride(_output_buffer, 1);
    int32_t _321 = _320 * _output_s0_y;
    int32_t _322 = _321 + _output_s0_x;
    ((uint8_t *)_output)[_322] = _319;
   } // for _output_s0_x
  } // for _output_s0_y
