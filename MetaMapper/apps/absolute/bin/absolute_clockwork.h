#ifndef HALIDE_____bin___absolute_clockwork_h
#define HALIDE_____bin___absolute_clockwork_h
#include <stdint.h>
...
int absolute_clockwork_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *absolute_clockwork_metadata() HALIDE_FUNCTION_ATTRS;
