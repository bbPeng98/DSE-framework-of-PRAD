...
static RDAI_Device aha_halide_hardware_camera_pipeline_shared_1 = {
	{ 1 },
	{
		{ "aha" },
		{ "halide_hardware"  },
		{ "camera_pipeline_shared" },
		1,
	},
...
static RDAI_Device *rdai_clockwork_platform_devices[2] = { &aha_halide_hardware_camera_pipeline_shared_1, NULL };
