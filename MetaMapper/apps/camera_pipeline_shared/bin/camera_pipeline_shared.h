#ifndef HALIDE_____bin___camera_pipeline_shared_h
#define HALIDE_____bin___camera_pipeline_shared_h
#include <stdint.h>
...
int camera_pipeline_shared(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int camera_pipeline_shared_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *camera_pipeline_shared_metadata() HALIDE_FUNCTION_ATTRS;
