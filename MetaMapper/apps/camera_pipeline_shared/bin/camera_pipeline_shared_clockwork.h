#ifndef HALIDE_____bin___camera_pipeline_shared_clockwork_h
#define HALIDE_____bin___camera_pipeline_shared_clockwork_h
#include <stdint.h>
...
int camera_pipeline_shared_clockwork_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *camera_pipeline_shared_clockwork_metadata() HALIDE_FUNCTION_ATTRS;
